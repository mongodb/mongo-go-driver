...
func BulkWrite(
	...
	for _, batch := range batches {
		...
		batchRes, err := runBatch(ctx, ns, topo, selector, ss, sess, clock, writeConcern, retryWrite,
			bypassDocValidation, bypassDocValidationSet, !ordered, batch)
		if err != nil {
			return bwRes, err
		}
...
func mergeResults(aggResult, newResult *result.BulkWrite, opIndex int64) {
