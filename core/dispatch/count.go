...
func Count(
	...
	if countOpts.Collation != nil {
		if desc.WireVersion.Max < 5 {
			return 0, fmt.Errorf("collation specified for invalid version")
		}
	...
	if countOpts.Hint != nil {
		...
		hint, err := bsoncodec.Marshal(countOpts.Hint)
		if err != nil {
			return 0, err
		}

		err = bsoncodec.Unmarshal(hint, &doc)
		if err != nil {
			return 0, err
		}

		cmd.Opts = append(cmd.Opts, bson.EC.SubDocument("hint", doc))
	}
