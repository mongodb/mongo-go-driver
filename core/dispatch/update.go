...
func Update(
	...
	if updateOpts.ArrayFilters != nil {
		if ss.Description().WireVersion.Max < 6 {
			return result.Update{}, errors.New("arrayFilters specified for invalid server version")
		}
	...
	if updateOpts.Collation != nil {
		if ss.Description().WireVersion.Max < 5 {
			return result.Update{}, errors.New("collation specified for invalid server version")
		}
