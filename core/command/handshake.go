...
func (h *Handshake) Encode() ([1]wiremessage.WireMessage, error) {
	var wms [1]wiremessage.WireMessage
...
// are called.
func (h *Handshake) Decode(wms [1]wiremessage.WireMessage) *Handshake {
...
// the isMaster command, using pipelining to enable a single roundtrip.
