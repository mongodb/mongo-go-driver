...
func TestCommandListCollections(t *testing.T) {
	...
	t.Run("SingleBatch", func(t *testing.T) {
		...
		testutil.InsertDocs(t, testutil.DBName(t), collOne, wc, bsonx.Doc{{"_id", bson.Int32(1)}})
		testutil.InsertDocs(t, testutil.DBName(t), collTwo, wc, bsonx.Doc{{"_id", bson.Int32(2)}})
		testutil.InsertDocs(t, testutil.DBName(t), collThree, wc, bsonx.Doc{{"_id", bson.Int32(3)}})
