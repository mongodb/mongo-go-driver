...
func TestCompression(t *testing.T) {
	...
	if compareVersions(t, serverVersion.StringValue(), "3.6") < 0 {
		t.Skip("skipping compression test for version < 3.6")
	}
	...
	compressor, err := snappy.MutableDocument().LookupErr("compressor")
	noerr(t, err)
