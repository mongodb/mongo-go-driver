...
func TestOpMsg(t *testing.T) {
	...
	t.Run("SingleDocInsert", func(t *testing.T) {
		...
		doc := bsonx.Doc{{"x", bson.String("testing single doc insert")}}
	...
	t.Run("MultiDocInsert", func(t *testing.T) {
		...
		doc1 := bsonx.Doc{{"x", bson.String("testing multi doc insert")}}
		doc2 := bsonx.Doc{{"y", bson.Int32(50)}}
	...
	t.Run("MultiDocDelete", func(t *testing.T) {
		...
		doc1 := bsonx.Doc{{"x", bson.String("x")}}
		doc2 := bsonx.Doc{{"y", bson.String("y")}}
