...
func NewClientSession(pool *Pool, sessionType Type, clusterTimeChan chan *bson.Document) (*Client, error) {
	...
	return &Client{
		ClusterTimeChan: clusterTimeChan,
...
// CluserTimeWireVersion is the minimum wire version that supports $clusterTime in messages
const ClusterTimeWireVersion = 6
