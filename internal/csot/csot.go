...
// parent.
//
// This is needed to refresh timeoutMS for operations that must run to
// completion even after the original timeout has expired, such as aborting a
// transaction during cleanup.
