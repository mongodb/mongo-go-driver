...
func NewClientEncryption(keyVaultClient *Client, opts ...options.Builder[options.ClientEncryptionOptions]) (*ClientEncryption, error) {
	...
	cea, err := mongoutil.NewOptionsFromBuilder(opts...)
	if err != nil {
		return nil, err
	}
...
func (ce *ClientEncryption) CreateEncryptedCollection(ctx context.Context,
	db *Database, coll string, createOpts options.Builder[options.CreateCollectionOptions],
	kmsProvider string, masterKey interface{}) (*Collection, bson.M, error) {
	if createOpts == nil {
		return nil, nil, errors.New("nil CreateCollectionOptions")
	}

	createArgs, err := mongoutil.NewOptionsFromBuilder[options.CreateCollectionOptions](createOpts)
	if err != nil {
	...
	updatedCreateOpts := mongoutil.NewBuilderFromOptions[options.CreateCollectionOptions](createArgs, nil)
...
func (ce *ClientEncryption) CreateDataKey(
	ctx context.Context,
	kmsProvider string,
	opts ...options.Builder[options.DataKeyOptions],
) (bson.Binary, error) {
	args, err := mongoutil.NewOptionsFromBuilder[options.DataKeyOptions](opts...)
	if err != nil {
...
func transformExplicitEncryptionOptions(opts ...options.Builder[options.EncryptOptions]) *mcopts.ExplicitEncryptionOptions {
	args, _ := mongoutil.NewOptionsFromBuilder[options.EncryptOptions](opts...)
	...
	if args.RangeOptions != nil {
		rangeArgs, _ := mongoutil.NewOptionsFromBuilder[options.RangeOptions](args.RangeOptions)
...
func (ce *ClientEncryption) Encrypt(
	ctx context.Context,
	val bson.RawValue,
	opts ...options.Builder[options.EncryptOptions],
) (bson.Binary, error) {
...
func (ce *ClientEncryption) RewrapManyDataKey(
	ctx context.Context,
	filter interface{},
	opts ...options.Builder[options.RewrapManyDataKeyOptions],
	...
	args, err := mongoutil.NewOptionsFromBuilder[options.RewrapManyDataKeyOptions](opts...)
	if err != nil {
