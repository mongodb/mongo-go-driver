...
// ConvertInsertOneOption implements the One interface
func (ob *OneBundle) ConvertInsertOneOption() option.InsertOptioner { return nil }
...
// ConvertInsertManyOption implements the Many interface
func (mb *ManyBundle) ConvertInsertManyOption() option.InsertOptioner { return nil }
