...
type ClientBulkWriteResult struct {
	...
	InsertResults map[int64]CientInsertOneResult
...
func newClientBulkWriteResult(result bsoncore.Document) *ClientBulkWriteResult {
	return &ClientBulkWriteResult{raw: result}
}

func (result *ClientBulkWriteResult) String() string {
	return result.raw.String()
}

// CientInsertOneResult is the result type returned by a client-level bulk write of InsertOne operation.
type CientInsertOneResult struct {
