...
func (iv IndexView) List(ctx context.Context) (Cursor, error) {
	...
	return dispatch.ListIndexes(ctx, listCmd, iv.coll.client.topology, iv.coll.writeSelectorT)
}
...
func (iv IndexView) CreateMany(ctx context.Context, models ...IndexModel) ([]string, error) {
	...
	_, err := dispatch.CreateIndexes(ctx, cmd, iv.coll.client.topology, iv.coll.writeSelectorT)
	if err != nil {
		return nil, err
	}
...
func (iv IndexView) DropOne(ctx context.Context, name string) (bson.Reader, error) {
	...
	return dispatch.DropIndexes(ctx, cmd, iv.coll.client.topology, iv.coll.writeSelectorT)
}
