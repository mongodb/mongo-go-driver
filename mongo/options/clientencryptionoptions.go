...
// This is required.
func (c *ClientEncryptionOptions) SetKeyVaultClientOptions(opts *ClientOptions) *ClientEncryptionOptions {
	c.KeyVaultClientOptions = opts
	return c
}
...
func MergeClientEncryptionOptions(opts ...*ClientEncryptionOptions) *ClientEncryptionOptions {
	...
	for _, opt := range opts {
		...
		if opt.KeyVaultClientOptions != nil {
			ceo.KeyVaultClientOptions = opt.KeyVaultClientOptions
		}
		if opt.KeyVaultNamespace != nil {
