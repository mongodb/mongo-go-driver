...
func TestCausalConsistency(t *testing.T) {
	...
	t.Run("TestNoTimeOnFirstCommand", func(t *testing.T) {
		...
		err = client.UseSessionWithOptions(ctx, func(mctx SessionContext) error {
	...
	t.Run("TestNonConsistentRead", func(t *testing.T) {
		...
		_ = client.UseSessionWithOptions(ctx, func(mctx SessionContext) error {
			_, _ = coll.Find(mctx, emptyDoc)
			return nil
		}, sessionopt.CausalConsistency(false))
