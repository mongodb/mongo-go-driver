...
func (coll *Collection) InsertOne(ctx context.Context, document interface{},
	...
	if wc == nil && coll.writeConcern != nil {
		oneOpts = append(oneOpts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
...
func (coll *Collection) InsertMany(ctx context.Context, documents []interface{},
	...
	if wc == nil && coll.writeConcern != nil {
		manyOpts = append(manyOpts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
		wc = coll.writeConcern
	}
...
func (coll *Collection) DeleteOne(ctx context.Context, filter interface{},
	...
	if wc == nil && coll.writeConcern != nil {
		deleteOpts = append(deleteOpts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
		wc = coll.writeConcern
	}
...
func (coll *Collection) updateOrReplaceOne(ctx context.Context, filter,
	...
	if wc == nil && coll.writeConcern != nil {
		opts = append(opts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
		wc = coll.writeConcern
	}
...
func (coll *Collection) UpdateMany(ctx context.Context, filter interface{}, update interface{},
	...
	if wc == nil && coll.writeConcern != nil {
		updOpts = append(updOpts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
		wc = coll.writeConcern
	}
...
func (coll *Collection) Aggregate(ctx context.Context, pipeline interface{},
	...
	if wc == nil && coll.writeConcern != nil {
		aggOpts = append(aggOpts, option.OptWriteConcern{WriteConcern: coll.writeConcern})
		wc = coll.writeConcern
	}
...
func (coll *Collection) Count(ctx context.Context, filter interface{},
	...
	if rc == nil && coll.readConcern != nil {
		countOpts = append(countOpts, option.OptReadConcern{ReadConcern: coll.readConcern})
		rc = coll.readConcern
	}
...
func (coll *Collection) Distinct(ctx context.Context, fieldName string, filter interface{},
	...
	var rc *readconcern.ReadConcern
	for _, opt := range distinctOpts {
		if converted, ok := opt.(option.OptReadConcern); ok {
			rc = converted.ReadConcern
		}
	}
	if rc == nil && coll.readConcern != nil {
		distinctOpts = append(distinctOpts, option.OptReadConcern{ReadConcern: coll.readConcern})
		rc = coll.readConcern
	}
...
func (coll *Collection) Find(ctx context.Context, filter interface{},
	...
	if rc == nil && coll.readConcern != nil {
		findOpts = append(findOpts, option.OptReadConcern{ReadConcern: coll.readConcern})
		rc = coll.readConcern
	}
...
func (coll *Collection) FindOne(ctx context.Context, filter interface{},
	...
	if rc == nil && coll.readConcern != nil {
		findOneOpts = append(findOneOpts, option.OptReadConcern{ReadConcern: coll.readConcern})
		rc = coll.readConcern
	}
