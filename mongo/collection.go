...
type Collection struct {
	...
	readSelectorT  topology.ServerSelector
	writeSelectorT topology.ServerSelector
}
...
func newCollection(db *Database, name string) *Collection {
	...
	coll.readSelectorT = topology.CompositeSelector([]topology.ServerSelector{
		topology.ReadPrefSelector(coll.readPreference),
		topology.LatencySelector(db.client.localThreshold),
	})

	coll.writeSelectorT = topology.ReadPrefSelector(readpref.Primary())
...
func (coll *Collection) InsertOne(ctx context.Context, document interface{},
	...
	_, err = dispatch.Insert(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
...
func (coll *Collection) DeleteOne(ctx context.Context, filter interface{},
	...
	res, err := dispatch.Delete(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
	if err != nil && err != dispatch.ErrUnacknowledgedWrite {
		return nil, err
	}
...
func (coll *Collection) updateOrReplaceOne(ctx context.Context, filter,
	...
	r, err := dispatch.Update(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
	if err != nil && err != dispatch.ErrUnacknowledgedWrite {
		return nil, err
	}
	res := &UpdateResult{
...
func (coll *Collection) Aggregate(ctx context.Context, pipeline interface{},
	...
	return dispatch.Aggregate(ctx, cmd, coll.client.topology, coll.readSelectorT, coll.writeSelectorT, coll.writeConcern)
}
...
func (coll *Collection) Count(ctx context.Context, filter interface{},
	...
	return dispatch.Count(ctx, cmd, coll.client.topology, coll.readSelectorT, coll.readConcern)
}
...
func (coll *Collection) Distinct(ctx context.Context, fieldName string, filter interface{},
	...
	res, err := dispatch.Distinct(ctx, cmd, coll.client.topology, coll.readSelectorT, coll.readConcern)
	if err != nil {
		return nil, err
	}
...
func (coll *Collection) Find(ctx context.Context, filter interface{},
	...
	return dispatch.Find(ctx, cmd, coll.client.topology, coll.readSelectorT, coll.readConcern)
}
...
func (coll *Collection) FindOne(ctx context.Context, filter interface{},
	...
	cursor, err := dispatch.Find(ctx, cmd, coll.client.topology, coll.readSelectorT, coll.readConcern)
	if err != nil {
		return &DocumentResult{err: err}
	}
...
func (coll *Collection) FindOneAndDelete(ctx context.Context, filter interface{},
	...
	res, err := dispatch.FindOneAndDelete(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
	if err != nil {
		return &DocumentResult{err: err}
	}
...
func (coll *Collection) FindOneAndReplace(ctx context.Context, filter interface{},
	...
	res, err := dispatch.FindOneAndReplace(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
	if err != nil {
		return &DocumentResult{err: err}
	}
...
func (coll *Collection) FindOneAndUpdate(ctx context.Context, filter interface{},
	...
	res, err := dispatch.FindOneAndUpdate(ctx, cmd, coll.client.topology, coll.writeSelectorT, coll.writeConcern)
	if err != nil {
		return &DocumentResult{err: err}
	}
