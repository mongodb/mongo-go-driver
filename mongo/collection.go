...
// UpdateByID executes an update command to update at most one document in the collection.
//
// The id parameter is the id of the document to be replaced. It cannot be nil. If the id does not match any documents,
