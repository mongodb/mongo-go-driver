...
// InsertOne inserts a single document into the collection. A user can supply a custom
...
// DeleteOne deletes a single document from the collection. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// DeleteMany deletes multiple documents from the collection. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// UpdateOne updates a single document in the collection. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// UpdateMany updates multiple documents in the collection. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// ReplaceOne replaces a single document in the collection. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// Count gets the number of documents matching the filter. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// Distinct finds the distinct values for a specified field across a single collection. A user
...
// FindOne returns up to one document that matches the model. A user can supply a custom
// context to this method.
//
// TODO GODRIVER-76: Document which types for interface{} are valid.
...
// FindOneAndUpdate finds a single document and updates it, returning either the original
