...
func (coll *Collection) delete(ctx context.Context, filter interface{}, deleteOne bool, expectedRr returnResult,
	...
	if do.Hint != nil {
		hint, err := transformValue(coll.registry, do.Hint, false)
		if err != nil {
			return nil, err
		}
...
func aggregate(a aggregateParams) (*Cursor, error) {
	...
	if ao.Hint != nil {
		hintVal, err := transformValue(a.registry, ao.Hint, false)
		if err != nil {
			closeImplicitSession(sess)
			return nil, err
		}
...
func (coll *Collection) CountDocuments(ctx context.Context, filter interface{},
	...
	if countOpts.Hint != nil {
		hintVal, err := transformValue(coll.registry, countOpts.Hint, false)
		if err != nil {
			return 0, err
		}
		op.Hint(hintVal)
...
func (coll *Collection) Find(ctx context.Context, filter interface{},
	...
	if fo.Hint != nil {
		hint, err := transformValue(coll.registry, fo.Hint, false)
		if err != nil {
			closeImplicitSession(sess)
			return nil, err
		}
	...
	if fo.Sort != nil {
		sort, err := transformBsoncoreDocument(coll.registry, fo.Sort, false)
		if err != nil {
			closeImplicitSession(sess)
			return nil, err
		}
...
func (coll *Collection) FindOneAndDelete(ctx context.Context, filter interface{},
	...
	if fod.Sort != nil {
		sort, err := transformBsoncoreDocument(coll.registry, fod.Sort, false)
		if err != nil {
			return &SingleResult{err: err}
		}
		op = op.Sort(sort)
	...
	if fod.Hint != nil {
		hint, err := transformValue(coll.registry, fod.Hint, false)
		if err != nil {
			return &SingleResult{err: err}
		}
		op = op.Hint(hint)
