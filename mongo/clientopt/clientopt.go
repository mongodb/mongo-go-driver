...
func (cb *ClientBundle) Monitor(m *monitor.CmdMonitor) *ClientBundle {
	return &ClientBundle{
		option: Monitor(m),
		next:   cb,
	}
...
func Monitor(m *monitor.CmdMonitor) Option {
	return optionFunc(
		func(c *Client) error {
			c.TopologyOptions = append(
				c.TopologyOptions,
				topology.WithServerOptions(func(opts ...topology.ServerOption) []topology.ServerOption {
					return append(
						...
						topology.WithConnectionOptions(func(opts ...connection.Option) []connection.Option {
							return append(
								opts,
								connection.WithMonitor(func(*monitor.CmdMonitor) *monitor.CmdMonitor {
									return m
								}),
							)
						}),
