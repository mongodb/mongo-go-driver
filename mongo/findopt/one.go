...
type One interface {
	one()
	ConvertFindOneOption() option.FindOneOptioner
}
...
func (ob *OneBundle) ConvertFindOneOption() option.FindOneOptioner { return nil }
...
func (ob *OneBundle) Unbundle(deduplicate bool) ([]option.FindOneOptioner, error) {
...
func (ob *OneBundle) unbundle() ([]option.FindOneOptioner, error) {
	if ob == nil {
		return nil, nil
	}
	...
	options := make([]option.FindOneOptioner, listLen)
	index := listLen - 1
