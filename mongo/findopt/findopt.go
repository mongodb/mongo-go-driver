...
func (opt OptAllowPartialResults) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptAllowPartialResults(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptBatchSize) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptBatchSize(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptCollation) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptCollation(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptCursorType) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptCursorType(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptComment) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptComment(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptHint) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptHint(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptLimit) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptLimit(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptMax) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptMax(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptMaxAwaitTime) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptMaxAwaitTime(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptMaxScan) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptMaxScan(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptMaxTime) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptMaxTime(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptMin) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptMin(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptNoCursorTimeout) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptNoCursorTimeout(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptOplogReplay) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptOplogReplay(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptProjection) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptProjection(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptReadConcern) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptReadConcern(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptReturnKey) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptReturnKey(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptShowRecordID) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptShowRecordID(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptSkip) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptSkip(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptSnapshot) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptSnapshot(opt)
}
...
// ConvertFindOneOption implements the One interface.
func (opt OptSort) ConvertFindOneOption() option.FindOneOptioner {
	return option.OptSort(opt)
}
