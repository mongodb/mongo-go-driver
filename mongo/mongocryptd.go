...
func newMongocryptdClient(opts map[string]interface{}) (*mongocryptdClient, error) {
	// create mongocryptdClient instance and spawn process if necessary
...
// createSpawnArgs creates arguments to spawn mongocryptdClient. It returns the path and a slice of arguments.
