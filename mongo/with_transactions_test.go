...
func setupConvenientTransactions(t *testing.T, extraClientOpts ...options.Builder[options.ClientOptions]) *Client {
	...
	fullClientOpts := []options.Builder[options.ClientOptions]{baseClientOpts}
