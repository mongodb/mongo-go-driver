...
// CreateCollection specifies whether or not a collection should be created for a test. This can only be true if the
// test has a Client as well. The default value is true.
