...
var (
	skippedTestDescriptions = map[string]struct{}{
		...
		// TODO(CSOT): Unskip these CSOT spec tests once createChangeStream operations are correctly formatted.
		...
		"timeoutMS can be set to 0 on a MongoDatabase - createChangeStream on database":       {},
		"timeoutMS can be configured on a MongoDatabase - createChangeStream on collection":   {},
		"timeoutMS can be set to 0 on a MongoDatabase - createChangeStream on collection":     {},
		"timeoutMS can be configured on a MongoCollection - createChangeStream on collection": {},
		"timeoutMS can be set to 0 on a MongoCollection - createChangeStream on collection":   {},
		// TODO(CSOT): Unskip these CSOT spec tests once estimatedDocumentCount correctly expects an aggregate instead of a count command.
		...
		"timeoutMS can be configured on a MongoDatabase - estimatedDocumentCount on collection":   {},
