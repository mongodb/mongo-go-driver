...
func TestScramSHA1Authenticator_Fails(t *testing.T) {
	...
	saslStartReply := msgtest.CreateCommandReply(bson.NewDocument(5).Append(
		bson.C.Int32("ok", 1),
...
func TestScramSHA1Authenticator_Missing_challenge_fields(t *testing.T) {
	...
	saslStartReply := msgtest.CreateCommandReply(bson.NewDocument(4).Append(
		bson.C.Int32("ok", 1),
		bson.C.Int32("conversationId", 1),
...
func TestScramSHA1Authenticator_Invalid_server_signature(t *testing.T) {
	...
	saslContinueReply := msgtest.CreateCommandReply(bson.NewDocument(4).Append(
		bson.C.Int32("ok", 1),
		bson.C.Int32("conversationId", 1),
		bson.C.Binary("payload", payload),
		bson.C.Boolean("done", false),
...
func TestScramSHA1Authenticator_Extra_message(t *testing.T) {
	...
	saslContinueReply2 := msgtest.CreateCommandReply(bson.NewDocument(4).Append(
		bson.C.Int32("ok", 1),
		bson.C.Int32("conversationId", 1),
		bson.C.Binary("payload", []byte{}),
		bson.C.Boolean("done", false),
...
func TestScramSHA1Authenticator_Succeeds(t *testing.T) {
	...
	expectedCmd := bson.NewDocument(3).Append(
