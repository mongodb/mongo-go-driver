...
func initCollection(t *testing.T, coll *Collection) {
	doc1 := bsonx.Doc{{"x", bson.Int32(1)}}
	doc2 := bsonx.Doc{{"x", bson.Int32(2)}}
	doc3 := bsonx.Doc{{"x", bson.Int32(3)}}
	doc4 := bsonx.Doc{{"x", bson.Int32(4)}}
	doc5 := bsonx.Doc{{"x", bson.Int32(5)}}
...
func TestCollection_InsertOne(t *testing.T) {
	...
	id := objectid.New()
	want := bsonx.Elem{"_id", bson.ObjectID(id)}
	doc := bsonx.Doc{want, {"x", bson.Int32(1)}}
...
func TestCollection_InsertOne_WriteError(t *testing.T) {
	...
	doc := bsonx.Doc{{"_id", bson.ObjectID(objectid.New())}}
	coll := createTestCollection(t, nil, nil)
...
func TestCollection_InsertMany(t *testing.T) {
	...
	want1 := bsonx.Elem{"_id", bson.Int32(11)}
	want2 := bsonx.Elem{"_id", bson.Int32(12)}
	docs := []interface{}{
		bsonx.Doc{want1},
		bsonx.Doc{{"x", bson.Int32(6)}},
		bsonx.Doc{want2},
	}
	coll := createTestCollection(t, nil, nil)
...
func TestCollection_InsertMany_ErrorCases(t *testing.T) {
	...
	want := WriteError{Code: 11000}
	docs := []interface{}{
		bsonx.Doc{{"_id", bson.ObjectID(objectid.New())}},
		bsonx.Doc{{"_id", bson.ObjectID(objectid.New())}},
		bsonx.Doc{{"_id", bson.ObjectID(objectid.New())}},
	}
	coll := createTestCollection(t, nil, nil)
...
func TestCollection_DeleteOne_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(1)}}
...
func TestCollection_DeleteOne_notFound(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(0)}}
	result, err := coll.DeleteOne(context.Background(), filter)
	require.Nil(t, err)
...
func TestCollection_DeleteMany_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bsonx.Document(bsonx.Doc{{"$gte", bson.Int32(3)}})}}
...
func TestCollection_DeleteMany_notFound(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bsonx.Document(bsonx.Doc{{"$lt", bson.Int32(1)}})}}
...
func TestCollection_UpdateOne_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(1)}}
	update := bsonx.Doc{{"$inc", bsonx.Document(bsonx.Doc{{"x", bson.Int32(1)}})}}
...
func TestCollection_UpdateOne_WriteError(t *testing.T) {
	...
	filter := bsonx.Doc{{"_id", bson.String("foo")}}
	update := bsonx.Doc{{"$set", bsonx.Document(bsonx.Doc{{"_id", bson.Double(3.14159)}})}}
	coll := createTestCollection(t, nil, nil)

	_, err := coll.InsertOne(context.Background(), bsonx.Doc{{"_id", bson.String("foo")}})
	require.NoError(t, err)
...
func TestCollection_UpdateOne_WriteConcernError(t *testing.T) {
	...
	want := WriteConcernError{Code: 100, Message: "Not enough data-bearing nodes"}
	filter := bsonx.Doc{{"_id", bson.String("foo")}}
	update := bsonx.Doc{{"$set", bsonx.Document(bsonx.Doc{{"pi", bson.Double(3.14159)}})}}
	coll := createTestCollection(t, nil, nil,
		options.Collection().SetWriteConcern(writeconcern.New(writeconcern.W(25))))
...
func TestCollection_ReplaceOne_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(1)}}
	replacement := bsonx.Doc{{"y", bson.Int32(1)}}
...
func TestCollection_ReplaceOne_WriteError(t *testing.T) {
	...
	filter := bsonx.Doc{{"_id", bson.String("foo")}}
	replacement := bsonx.Doc{{"_id", bson.Double(3.14159)}}
	coll := createTestCollection(t, nil, nil)
...
func TestCollection_ReplaceOne_WriteConcernError(t *testing.T) {
	...
	want := WriteConcernError{Code: 100, Message: "Not enough data-bearing nodes"}
	filter := bsonx.Doc{{"_id", bson.String("foo")}}
	update := bsonx.Doc{{"pi", bson.Double(3.14159)}}
	coll := createTestCollection(t, nil, nil,
		options.Collection().SetWriteConcern(writeconcern.New(writeconcern.W(25))))
...
func TestCollection_Aggregate(t *testing.T) {
	...
	pipeline := bsonx.Arr{
		bsonx.Document(
			bsonx.Doc{{"$match", bsonx.Document(bsonx.Doc{{"x", bsonx.Document(bsonx.Doc{{"$gte", bson.Int32(2)}})}})}},
		),
		bsonx.Document(
			bsonx.Doc{{
				"$project",
		...
		bsonx.Document(
			bsonx.Doc{{"$sort", bsonx.Document(bsonx.Doc{{"x", bson.Int32(1)}})}},
		)}
...
func TestCollection_Aggregate_IndexHint(t *testing.T) {
	...
	aggOpts := options.Aggregate().SetHint(bsonx.Doc{{"x", bson.Int32(1)}})
...
func TestCollection_Count_withFilter(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bsonx.Document(bsonx.Doc{{"$gt", bson.Int32(2)}})}}
...
func TestCollection_Find_found(t *testing.T) {
	...
	cursor, err := coll.Find(context.Background(),
		nil,
		options.Find().SetSort(bsonx.Doc{{"x", bson.Int32(1)}}),
	)
	require.Nil(t, err)
...
func TestCollection_Find_notFound(t *testing.T) {
	...
	cursor, err := coll.Find(context.Background(), bsonx.Doc{{"x", bson.Int32(6)}})
	require.Nil(t, err)
...
func TestCollection_FindOne_notFound(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(6)}}
...
func TestCollection_FindOneAndDelete_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(3)}}
...
func TestCollection_FindOneAndReplace_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(3)}}
	replacement := bsonx.Doc{{"y", bson.Int32(3)}}
...
func TestCollection_FindOneAndReplace_notFound(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(6)}}
	replacement := bsonx.Doc{{"y", bson.Int32(6)}}
...
func TestCollection_FindOneAndUpdate_found(t *testing.T) {
	...
	filter := bsonx.Doc{{"x", bson.Int32(3)}}
	update := bsonx.Doc{{"$set", bsonx.Document(bsonx.Doc{{"x", bson.Int32(6)}})}}
