...
func TestValue(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Interface/Boolean", Boolean(true).Interface, []interface{}{true}, nil},
		...
		{"IsNumber/Double", Double(0).IsNumber, []interface{}{true}, nil},
		{"IsNumber/Int32", Int32(0).IsNumber, []interface{}{true}, nil},
		{"IsNumber/Int64", Int64(0).IsNumber, []interface{}{true}, nil},
		{"IsNumber/Decimal128", Decimal128(primitive.Decimal128{}).IsNumber, []interface{}{true}, nil},
		{"IsNumber/String", String("").IsNumber, []interface{}{false}, nil},
		...
		{"Boolean/success", Boolean(true).Boolean, []interface{}{true}, nil},
		{"BooleanOK/error", Double(0).BooleanOK, []interface{}{false, false}, nil},
