...
// createReadPrefSelector will either return the selector provided or create a read preference
// selector with the provided read preference.
func createReadPrefSelector(selector description.ServerSelector, rp *readpref.ReadPref) description.ServerSelector {
	if selector != nil {
		return selector
	}
	if rp == nil {
