...
type InsertOperation struct {
	...
	database string `drivergen:",database"`

	// Collection sets the collection to run this operation against.
	collection string `drivergen:",collection,commandParameter"`
...
// TODO(GODRIVER-617): This should be generated by drivergen. Actually, this can just be handled by
// OperationContext.
