...
// BuildInsertResult constructs a InsertResult from the provided response document
// and server.
...
func (i *Insert) processResponse(response bsoncore.Document, srvr driver.Server) error {
...
func (i *Insert) Execute(ctx context.Context) error {
	if i.deployment == nil {
		return errors.New("Insert must have a Deployment set before Execute can be called.")
	}
