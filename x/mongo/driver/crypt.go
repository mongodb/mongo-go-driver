...
// ExplicitlyEncrypt encrypts the given value with the given options.
func (c *Crypt) ExplicitlyEncrypt(ctx context.Context, val bsoncore.Value, opts *options.ExplicitEncryptionOptions) (byte, []byte, error) {
...
// ExplicitlyDecrypt decrypts the given encrypted value.
func (c *Crypt) ExplicitlyDecrypt(ctx context.Context, subtype byte, data []byte) (bsoncore.Value, error) {
	idx, doc := bsoncore.AppendDocumentStart(nil)
