	...
	for _, tc := range testCases {
		...
		t.Run(tc.desc, func(t *testing.T) {
			...
			server := NewServer(
				...
				WithConnectionOptions(func(opts *mnet.Options) *mnet.Options {
					return &mnet.Options{
						Dialer: &timeoutDialer{&dialer{}, errors},
					}
				}),
...
//	testCases := []struct {
//		desc              string
//		dialer            func(mnet.Dialer) mnet.Dialer
//		handshaker        func(mnet.Handshaker) mnet.Handshaker
...
//			desc: newProcessErrorTestConn(t,
...
//				Code: 1,
//			},
//			desc:           newProcessErrorTestConn(t, &description.VersionRange{Max: 17}, false),
//			want:           driver.NoChange,
//			wantGeneration: 0,
//			wantDescription: description.Server{
//				Kind: description.RSPrimary,
...
//				},
//			},
//			desc:           newProcessErrorTestConn(t, &description.VersionRange{Max: 7}, false),
//			want:           driver.ConnectionPoolCleared,
//			wantGeneration: 1,
//			wantDescription: newServerDescription(description.Unknown, processID, 1, driver.WriteCommandError{
//				WriteConcernError: &driver.WriteConcernError{
...
//
//			got := server.ProcessError(tc.inputErr, tc.desc)
...
//	}
//
//	mnetconnr := mnet.NewConnection(peconn)
//
//	return mnetconn
//}
//
