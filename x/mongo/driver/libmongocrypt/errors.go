...
// MongoCryptError represents an error from an operation on a MongoCrypt instance.
...
func (me MongoCryptError) Error() string {
	return fmt.Sprintf("mongocrypt error %d: %v", me.Code, me.Message)
}

// mongoCryptErrorFromStatus builds a MongoCryptError from a mongocrypt_status_t object.
func mongoCryptErrorFromStatus(status *C.mongocrypt_status_t) error {
