...
func NewClientSession(pool *Pool, clientID uuid.UUID, sessionType Type, opts ...*ClientOptions) (*Client, error) {
	...
	if mergedOpts.DefaultMaxCommitTimeMS != nil {
		c.transactionMctms = mergedOpts.DefaultMaxCommitTimeMS
	}
...
func (c *Client) StartTransaction(opts *TransactionOptions) error {
	...
	if opts != nil {
		...
		c.CurrentMctms = opts.MaxCommitTimeMS
	}
	...
	if c.CurrentMctms == nil {
		c.CurrentMctms = c.transactionMctms
	}
