...
// RetryType implements the Deployment interface. It always returns RetryType(0), because a single
// server does not support retryability.
func (SingleServerDeployment) RetryType() RetryType { return RetryType(0) }
...
func (ssd SingleConnectionDeployment) RetryType() RetryType { return RetryType(0) }
