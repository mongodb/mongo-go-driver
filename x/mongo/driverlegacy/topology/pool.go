...
// newPool creates a new pool that will hold size number of idle connections and will create a max
// of capacity connections at any one time. It will use the provided options when creating
// connections.
