...
// ToSessionOptions combines the given *SessionOptions into a single *SessionOptions in a last one wins fashion.
func ToSessionOptions(opts ...*SessionOptions) *SessionOptions {
	s := Session()
