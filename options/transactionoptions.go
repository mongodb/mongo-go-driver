...
// ToTransactionOptions combines the given *TransactionOptions into a single *TransactionOptions in a last one wins
// fashion.
func ToTransactionOptions(opts ...*TransactionOptions) *TransactionOptions {
	t := Transaction()
