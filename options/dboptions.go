...
// ToDatabaseOptions combines the *DatabaseOptions arguments into a single *DatabaseOptions in a last one wins
// fashion.
func ToDatabaseOptions(opts ...*DatabaseOptions) *DatabaseOptions {
	d := Database()
