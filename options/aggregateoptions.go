...
type AggregateOptions struct {
	...
	MaxTime                  *int64      // The maximum amount of time to allow the query to run
	MaxAwaitTime             *int64      // The maximum amount of time for the server to wait on new documents to satisfy a tailable cursor query
...
func (ao *AggregateOptions) SetMaxTime(i int64) *AggregateOptions {
	ao.MaxTime = &i
	return ao
}
...
func (ao *AggregateOptions) SetMaxAwaitTime(i int64) *AggregateOptions {
	ao.MaxAwaitTime = &i
	return ao
}
