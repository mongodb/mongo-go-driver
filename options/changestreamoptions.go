...
type ChangeStreamOptions struct {
	...
	MaxAwaitTime *int64         // The maximum amount of time for the server to wait on new documents to satisfy a change stream query
...
func (cso *ChangeStreamOptions) SetMaxAwaitTime(i int64) *ChangeStreamOptions {
	cso.MaxAwaitTime = &i
	return cso
}
