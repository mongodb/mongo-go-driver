...
// NewEncoder returns a new encoder that uses EncodeContext ec to write to vw.
...
// NewEncoderWithRegistry returns a new encoder that uses Registry r to write to vw.
