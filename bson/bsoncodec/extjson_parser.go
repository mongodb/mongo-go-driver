...
func newExtJSONParser(r io.Reader, ext bool) *extJSONParser {
...
func (ejp *extJSONParser) peekType() (bson.Type, error) {
	...
	case jpsSawBeginObject:
		// if not parsing extended JSON, just treat this as an embedded document
		if !ejp.ext {
...
func (ejp *extJSONParser) readValue(t bson.Type) (*extJSONValue, error) {
	...
	case bson.TypeDateTime:
		// TODO check if reading extended or not
		switch ejp.s {
		case jpsSawValue:
			v = ejp.v
		case jpsSawKey:
