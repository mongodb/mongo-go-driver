...
// implement ValueWriter may also implement this interface. Implementations
// should not attempt to validate the bytes. It is the caller's responsibility
// to ensure the correct bytes are being written.
