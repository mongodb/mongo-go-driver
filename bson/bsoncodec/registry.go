...
func NewRegistryBuilder() *RegistryBuilder {
	...
	interfaceEncoders := []interfaceValueEncoder{
		interfaceValueEncoder{i: tValueMarshaler, ve: ValueEncoderFunc(dve.ValueMarshalerEncodeValue)},
	}

	interfaceDecoders := []interfaceValueDecoder{
		interfaceValueDecoder{i: tValueUnmarshaler, vd: ValueDecoderFunc(dvd.ValueUnmarshalerDecodeValue)},
	}
