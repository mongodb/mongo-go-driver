...
func TestDefaultValueDecoders(t *testing.T) {
	...
	var ptrPtrValueUnmarshaler **testValueUnmarshaler = nil
	...
	t.Run("ValueUnmarshalerDecodeValue/Pointer to ValueUnmarshaler", func(t *testing.T) {
		...
		var want **testValueUnmarshaler = new(*testValueUnmarshaler)
		var got **testValueUnmarshaler = new(*testValueUnmarshaler)
		...
		testCases := []struct {
			...
			},
			{
				...
				struct {
					...
					AE: []*testValueUnmarshaler{
						&testValueUnmarshaler{t: bson.TypeString, val: llbson.AppendString(nil, "hello")},
						&testValueUnmarshaler{t: bson.TypeString, val: llbson.AppendString(nil, "world")},
					},
				},
				docToBytes(bson.NewDocument(
