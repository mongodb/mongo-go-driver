...
func TestDefaultValueDecoders(t *testing.T) {
	...
	var nilPtrValueUnmarshaler *testValueUnmarshaler
			...
			[]subtest{
				...
				},
				{
					...
					ValueDecoderError{
						Name:     "ValueUnmarshalerDecodeValue",
						Types:    []reflect.Type{tValueUnmarshaler},
						Received: reflect.ValueOf(nilPtrValueUnmarshaler),
					},
				},
			},
		},
		...
		testCases := []struct {
			...
			},
			{
				...
				struct {
					...
					AH *int32
					AI *int64
					AJ *objectid.ObjectID
					AK *objectid.ObjectID
