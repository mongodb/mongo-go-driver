// Package bsoncodec provides a system for encoding values to BSON and decoding values from BSON.
...
// representations.
//
// 2) A Registry that holds these ValueEncoders and Decoders and provides methods for retrieving
// them.
//
...
// is provided to allow use of a function with the correct sigunature as a ValueEncoder. An
...
//
//  var regbuilder *RegistryBuilder
//  intType := reflect.TypeOf(int(0))
//  regbuilder.RegisterTypeMapEntry(bsontype.Int64, intType).RegisterTypeMapEntry(bsontype.Int32, intType)
//
// DefaultValueEncoders and DefaultValueDecoders
//
// The DefaultValueEncoders and DefalutValueDecoders types provide a full set of ValueEncoders and
// ValueDecoders for handling a wide range of Go types, including all of the types within the
// primitive package. To make registering these codecs with a RegistryBuilder a helper method on
// each type is provided. For the DefaultValueEncoders type the method is called
// RegisterDefaultEncoders and for the DefaultValueDecoders type the method is called
// RegisterDefaultDecoders, this method also handles registering type map entries for each BSON
// type.
package bsoncodec
