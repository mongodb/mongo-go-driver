...
func TestBasicDecodeDocumentReader(t *testing.T) {
	for _, tc := range unmarshalingTestCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			doc, err := bson.ReadDocument(tc.data)
			noerr(t, err)
...
func TestDocumentValueReader(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			[]interface{}{[]byte(nil), byte(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeBinary)},
		},
		{
			"ReadBinary/success",
			bson.VC.BinaryWithSubtype([]byte{0x01, 0x02, 0x03}, 0xEA),
			reflect.ValueOf((*documentValueReader).ReadBinary),
		...
		},
		{
			...
			[]interface{}{false, (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeBoolean)},
		},
		{
			"ReadBoolean/success",
			bson.VC.Boolean(true),
			reflect.ValueOf((*documentValueReader).ReadBoolean),
			[]interface{}{true, nil},
		},
		{
			...
			[]interface{}{"", objectid.ObjectID{}, (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeDBPointer)},
		},
		{
			"ReadDBPointer/success",
			bson.VC.DBPointer("foobar", oid),
			reflect.ValueOf((*documentValueReader).ReadDBPointer),
		...
		},
		{
			...
			[]interface{}{int64(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeDateTime)},
		},
		{
			"ReadDateTime/success",
			bson.VC.DateTime(now),
			reflect.ValueOf((*documentValueReader).ReadDateTime),
			[]interface{}{now, nil},
		},
		{
			...
			[]interface{}{decimal.Decimal128{}, (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeDecimal128)},
		},
		{
			"ReadDecimal128/success",
			bson.VC.Decimal128(d128),
			reflect.ValueOf((*documentValueReader).ReadDecimal128),
			[]interface{}{d128, nil},
		},
		{
			...
			[]interface{}{float64(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeDouble)},
		},
		{
			"ReadDouble/success",
			bson.VC.Double(1.2345),
			reflect.ValueOf((*documentValueReader).ReadDouble),
		...
		},
		{
			...
			[]interface{}{int32(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeInt32)},
		},
		{
			"ReadInt32/success",
			bson.VC.Int32(12345),
		...
		},
		{
			...
			[]interface{}{int64(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeInt64)},
		},
		{
			"ReadInt64/success",
			bson.VC.Int64(1234567890),
			reflect.ValueOf((*documentValueReader).ReadInt64),
		...
		},
		{
			...
			[]interface{}{"", (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeJavaScript)},
		},
		{
			"ReadJavascript/success",
			bson.VC.JavaScript("var foo = bar;"),
			reflect.ValueOf((*documentValueReader).ReadJavascript),
		...
		},
		{
			...
			[]interface{}{(&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeMaxKey)},
		},
		{
			"ReadMaxKey/success",
			bson.VC.MaxKey(),
		...
		},
		{
			...
			[]interface{}{(&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeMinKey)},
		},
		{
			"ReadMinKey/success",
			bson.VC.MinKey(),
		...
		},
		{
			...
			[]interface{}{(&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeNull)},
		},
		{
			"ReadNull/success",
			bson.VC.Null(),
		...
		},
		{
			...
			[]interface{}{objectid.ObjectID{}, (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeObjectID)},
		},
		{
			"ReadObjectID/success",
			bson.VC.ObjectID(oid),
			reflect.ValueOf((*documentValueReader).ReadObjectID),
			[]interface{}{oid, nil},
		},
		{
			...
			[]interface{}{"", "", (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeRegex)},
		},
		{
			"ReadRegex/success",
			bson.VC.Regex("foo", "bar"),
			reflect.ValueOf((*documentValueReader).ReadRegex),
		...
		},
		{
			...
			[]interface{}{"", (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeString)},
		},
		{
			"ReadString/success",
			bson.VC.String("hello, world!"),
			reflect.ValueOf((*documentValueReader).ReadString),
		...
		},
		{
			...
			[]interface{}{"", (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeSymbol)},
		},
		{
			"ReadSymbol/success",
			bson.VC.Symbol("hello, world!"),
			reflect.ValueOf((*documentValueReader).ReadSymbol),
			[]interface{}{"hello, world!", nil},
		},
		{
			...
			[]interface{}{uint32(0), uint32(0), (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeTimestamp)},
		},
		{
			"ReadTimestamp/success",
			bson.VC.Timestamp(10, 20),
			reflect.ValueOf((*documentValueReader).ReadTimestamp),
		...
		},
		{
			...
			[]interface{}{(&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeUndefined)},
		},
		{
		...
		},
		{
			...
			[]interface{}{"", nil, (&documentValueReader{stack: []dvrState{{}}}).typeError(bson.TypeCodeWithScope)},
		},
	}
	...
	t.Run("ReadCodeWithScope/success", func(t *testing.T) {
		...
		doc := bson.NewDocument(
			bson.EC.CodeWithScope(wantkey, wantcode,
				bson.NewDocument(bson.EC.Undefined("bar")),
			))
		dvr := &documentValueReader{
			stack: []dvrState{
	...
	t.Run("Skip/success", func(t *testing.T) {
		...
		doc := bson.NewDocument(bson.EC.String(firstkey, "bar"), bson.EC.Null(secondkey))
