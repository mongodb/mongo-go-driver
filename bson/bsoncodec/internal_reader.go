...
//
// Implementations must copy the bytes to dst if there is enough space. If there
// is not, implementations must append the bytes to dst and return the new
// []byte.
type BytesReader interface {
	ReadBytes(dst []byte) ([]byte, error)
}
