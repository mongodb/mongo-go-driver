	...
	*pjsnum = json.Number("3.14159")
	...
	testCases := []struct {
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &StringCodec{}, Types: []interface{}{string(""), bson.JavaScriptCode(""), bson.Symbol("")}, Received: wrong},
				},
			...
			[]deccase{
				{
					...
					llvrwReadString,
					CodecDecodeError{Codec: &StringCodec{}, Types: []interface{}{(*string)(nil), (*bson.JavaScriptCode)(nil), (*bson.Symbol)(nil)}, Received: &wrong},
				},
				{
					"type not string",
					string(""),
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &BinaryCodec{}, Types: []interface{}{bson.Binary{}, (*bson.Binary)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &UndefinedCodec{}, Types: []interface{}{bson.Undefinedv2{}, (*bson.Undefinedv2)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &DateTimeCodec{}, Types: []interface{}{bson.DateTime(0), (*bson.DateTime)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &NullCodec{}, Types: []interface{}{bson.Nullv2{}, (*bson.Nullv2)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &RegexCodec{}, Types: []interface{}{bson.Regex{}, (*bson.Regex)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &DBPointerCodec{}, Types: []interface{}{bson.DBPointer{}, (*bson.DBPointer)(nil)}, Received: wrong},
				},
				{
					"DBPointer/success",
					bson.DBPointer{
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &CodeWithScopeCodec{}, Types: []interface{}{bson.CodeWithScope{}, (*bson.CodeWithScope)(nil)}, Received: wrong},
				},
				{
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &TimestampCodec{}, Types: []interface{}{bson.Timestamp{}, (*bson.Timestamp)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &MinKeyCodec{}, Types: []interface{}{bson.MinKeyv2{}, (*bson.MinKeyv2)(nil)}, Received: wrong},
				},
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &MaxKeyCodec{}, Types: []interface{}{bson.MaxKeyv2{}, (*bson.MaxKeyv2)(nil)}, Received: wrong},
				},
		...
		},
		{
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &elementCodec{}, Types: []interface{}{(*bson.Element)(nil)}, Received: wrong},
				},
			...
			[]deccase{
				{
					"cannot use directly",
					(*bson.Element)(nil), nil, nil, llvrwNothing,
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &ValueCodec{}, Types: []interface{}{(*bson.Value)(nil)}, Received: wrong},
				},
			...
			[]deccase{
				{
					...
					nil,
					llvrwNothing,
					CodecDecodeError{Codec: &ValueCodec{}, Types: []interface{}{(**bson.Value)(nil)}, Received: &wrong},
				},
				{"invalid value", (**bson.Value)(nil), nil, nil, llvrwNothing, fmt.Errorf("%T can only be used to decode non-nil **Value", &ValueCodec{})},
				{
					"success",
			...
			[]enccase{
				{
					...
					nil,
					llvrwNothing,
					CodecEncodeError{Codec: &ReaderCodec{}, Types: []interface{}{bson.Reader{}}, Received: wrong},
				},
				{
					"WriteDocument Error",
					bson.Reader{},
			...
			[]deccase{
				{
					...
					&llValueReaderWriter{},
					llvrwNothing,
					CodecDecodeError{Codec: &ReaderCodec{}, Types: []interface{}{(*bson.Reader)(nil)}, Received: &wrong},
				},
				{
					"*Reader is nil",
					(*bson.Reader)(nil),
		...
		},
		{
			...
			[]deccase{
				...
				},
				{
					...
					&llValueReaderWriter{bsontype: bson.TypeBinary, readval: bson.Binary{Data: []byte{0x01, 0x02, 0x03}, Subtype: 0xFF}},
					llvrwReadBinary,
					fmt.Errorf("%T can only be used to decode subtype 0x00 for %s, got %v", &ByteSliceCodec{}, bson.TypeBinary, byte(0xFF)),
				},
			},
		},
	}
	...
	t.Run("DocumentCodec", func(t *testing.T) {
		t.Run("EncodeValue", func(t *testing.T) {
			t.Run("CodecEncodeError", func(t *testing.T) {
				val := bool(true)
				want := CodecEncodeError{Codec: &DocumentCodec{}, Types: []interface{}{(*bson.Document)(nil)}, Received: val}
			...
			t.Run("WriteDocument Error", func(t *testing.T) {
				...
				got := (&DocumentCodec{}).EncodeValue(EncodeContext{}, llvrw, bson.NewDocument())
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
		...
		t.Run("DecodeValue", func(t *testing.T) {
			t.Run("CodecDecodeError", func(t *testing.T) {
				val := bool(true)
				want := CodecDecodeError{Codec: &DocumentCodec{}, Types: []interface{}{(**bson.Document)(nil)}, Received: val}
				got := (&DocumentCodec{}).DecodeValue(DecodeContext{}, &llValueReaderWriter{bsontype: bson.TypeEmbeddedDocument}, val)
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
			t.Run("ReadDocument Error", func(t *testing.T) {
				...
				got := (&DocumentCodec{}).DecodeValue(DecodeContext{}, llvrw, new(*bson.Document))
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
			t.Run("decodeDocument errors", func(t *testing.T) {
				...
				for _, tc := range testCases {
					t.Run(tc.name, func(t *testing.T) {
						err := (&DocumentCodec{}).decodeDocument(tc.dc, tc.llvrw, new(*bson.Document))
						if !compareErrors(err, tc.err) {
							t.Errorf("Errors do not match. got %v; want %v", err, tc.err)
						}
					})
	...
	t.Run("ArrayCodec", func(t *testing.T) {
		t.Run("EncodeValue", func(t *testing.T) {
			t.Run("CodecEncodeError", func(t *testing.T) {
				val := bool(true)
				want := CodecEncodeError{Codec: &ArrayCodec{}, Types: []interface{}{(*bson.Array)(nil)}, Received: val}
			...
			t.Run("WriteArray Error", func(t *testing.T) {
				...
				got := (&ArrayCodec{}).EncodeValue(EncodeContext{}, llvrw, bson.NewArray())
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
		...
		t.Run("DecodeValue", func(t *testing.T) {
			t.Run("CodecDecodeError", func(t *testing.T) {
				val := bool(true)
				want := CodecDecodeError{Codec: &ArrayCodec{}, Types: []interface{}{(**bson.Array)(nil)}, Received: val}
				got := (&ArrayCodec{}).DecodeValue(DecodeContext{}, &llValueReaderWriter{bsontype: bson.TypeArray}, val)
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
			t.Run("ReadArray Error", func(t *testing.T) {
				...
				got := (&ArrayCodec{}).DecodeValue(DecodeContext{}, llvrw, new(*bson.Array))
				if !compareErrors(got, want) {
					t.Errorf("Errors do not match. got %v; want %v", got, want)
				}
			})
			t.Run("decode array errors", func(t *testing.T) {
				...
				for _, tc := range testCases {
					t.Run(tc.name, func(t *testing.T) {
						err := (&ArrayCodec{}).DecodeValue(tc.dc, tc.llvrw, new(*bson.Array))
						if !compareErrors(err, tc.err) {
							t.Errorf("Errors do not match. got %v; want %v", err, tc.err)
						}
					})
