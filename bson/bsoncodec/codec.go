...
func (sc *StringCodec) EncodeValue(ectx EncodeContext, vw ValueWriter, i interface{}) error {
	...
	if val.Type().Kind() != reflect.String {
		return CodecEncodeError{Codec: sc, Types: []interface{}{string(""), bson.JavaScriptCode(""), bson.Symbol("")}, Received: i}
	}
...
func (sc *StringCodec) DecodeValue(dctx DecodeContext, vr ValueReader, i interface{}) error {
	...
	if val.Type().Kind() != reflect.String {
		return CodecDecodeError{Codec: sc, Types: []interface{}{(*string)(nil), (*bson.JavaScriptCode)(nil), (*bson.Symbol)(nil)}, Received: i}
	}
...
func (dc *DocumentCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	if !ok {
		return CodecEncodeError{Codec: dc, Types: []interface{}{(*bson.Document)(nil)}, Received: i}
	}
...
func (dc DocumentCodec) encodeDocument(ec EncodeContext, dw DocumentWriter, doc *bson.Document) error {
	itr := doc.Iterator()
...
func (dc *DocumentCodec) DecodeValue(dctx DecodeContext, vr ValueReader, i interface{}) error {
	doc, ok := i.(**bson.Document)
	if !ok {
		return CodecDecodeError{Codec: dc, Types: []interface{}{(**bson.Document)(nil)}, Received: i}
	}
...
func (dc DocumentCodec) decodeDocument(dctx DecodeContext, dr DocumentReader, pdoc **bson.Document) error {
...
func (ac *ArrayCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	arr, ok := i.(*bson.Array)
	if !ok {
		return CodecEncodeError{Codec: ac, Types: []interface{}{(*bson.Array)(nil)}, Received: i}
	}
...
func (ac *ArrayCodec) DecodeValue(dc DecodeContext, vr ValueReader, i interface{}) error {
	...
	if !ok {
		return CodecDecodeError{Codec: ac, Types: []interface{}{(**bson.Array)(nil)}, Received: i}
	}
...
func (bc *BinaryCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.Binary:
		b = *t
	default:
		return CodecEncodeError{Codec: bc, Types: []interface{}{bson.Binary{}, (*bson.Binary)(nil)}, Received: i}
	}
...
func (uc *UndefinedCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	default:
		return CodecEncodeError{Codec: uc, Types: []interface{}{bson.Undefinedv2{}, (*bson.Undefinedv2)(nil)}, Received: i}
	}
...
func (dtc *DateTimeCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.DateTime:
		dt = *t
	default:
		return CodecEncodeError{Codec: dtc, Types: []interface{}{bson.DateTime(0), (*bson.DateTime)(nil)}, Received: i}
	}
...
func (nc *NullCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	default:
		return CodecEncodeError{Codec: nc, Types: []interface{}{bson.Nullv2{}, (*bson.Nullv2)(nil)}, Received: i}
	}
...
func (rc *RegexCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.Regex:
		regex = *t
	default:
		return CodecEncodeError{Codec: rc, Types: []interface{}{bson.Regex{}, (*bson.Regex)(nil)}, Received: i}
	}
...
func (dbpc *DBPointerCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.DBPointer:
		dbp = *t
	default:
		return CodecEncodeError{Codec: dbpc, Types: []interface{}{bson.DBPointer{}, (*bson.DBPointer)(nil)}, Received: i}
	}
...
func (cwsc *CodeWithScopeCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.CodeWithScope:
		cws = *t
	default:
		return CodecEncodeError{Codec: cwsc, Types: []interface{}{bson.CodeWithScope{}, (*bson.CodeWithScope)(nil)}, Received: i}
	}
...
func (tc *TimestampCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *bson.Timestamp:
		ts = *t
	default:
		return CodecEncodeError{Codec: tc, Types: []interface{}{bson.Timestamp{}, (*bson.Timestamp)(nil)}, Received: i}
	}
...
func (mkc *MinKeyCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	default:
		return CodecEncodeError{Codec: mkc, Types: []interface{}{bson.MinKeyv2{}, (*bson.MinKeyv2)(nil)}, Received: i}
	}
...
func (mkc *MaxKeyCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	default:
		return CodecEncodeError{Codec: mkc, Types: []interface{}{bson.MaxKeyv2{}, (*bson.MaxKeyv2)(nil)}, Received: i}
	}
...
func (ec *elementCodec) EncodeValue(ectx EncodeContext, vw ValueWriter, i interface{}) error {
	...
	if !ok {
		return CodecEncodeError{Codec: ec, Types: []interface{}{(*bson.Element)(nil)}, Received: i}
	}
...
func (ec *elementCodec) encodeValue(ectx EncodeContext, vw ValueWriter, elem *bson.Element) error {
	return defaultValueCodec.encodeValue(ectx, vw, elem.Value())
}

func (ec *elementCodec) decodeValue(dc DecodeContext, vr ValueReader, key string, elem **bson.Element) error {
	switch vr.Type() {
	case bson.TypeDouble:
		f64, err := vr.ReadDouble()
		if err != nil {
...
func (vc *ValueCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	val, ok := i.(*bson.Value)
	if !ok {
		return CodecEncodeError{Codec: vc, Types: []interface{}{(*bson.Value)(nil)}, Received: i}
	}
...
// this method.
func (vc *ValueCodec) encodeValue(ec EncodeContext, vw ValueWriter, val *bson.Value) error {
	var err error
	switch val.Type() {
	case bson.TypeDouble:
...
func (vc *ValueCodec) DecodeValue(dc DecodeContext, vr ValueReader, i interface{}) error {
	...
	if !ok {
		return CodecDecodeError{Codec: vc, Types: []interface{}{(**bson.Value)(nil)}, Received: i}
	}
...
func (vc *ValueCodec) decodeValue(dc DecodeContext, vr ValueReader, val **bson.Value) error {
	switch vr.Type() {
	case bson.TypeDouble:
		f64, err := vr.ReadDouble()
		if err != nil {
...
func (rc *ReaderCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	if !ok {
		return CodecEncodeError{Codec: rc, Types: []interface{}{bson.Reader{}}, Received: i}
	}
...
func (rc *ReaderCodec) DecodeValue(dc DecodeContext, vr ValueReader, i interface{}) error {
	rdr, ok := i.(*bson.Reader)
	if !ok {
		return CodecDecodeError{Codec: rc, Types: []interface{}{(*bson.Reader)(nil)}, Received: i}
	}
...
func (bsc *ByteSliceCodec) DecodeValue(dc DecodeContext, vr ValueReader, i interface{}) error {
	...
	if subtype != 0x00 {
		return fmt.Errorf("%T can only be used to decode subtype 0x00 for %s, got %v", bsc, bson.TypeBinary, subtype)
	}
...
func (esc *ElementSliceCodec) EncodeValue(ec EncodeContext, vw ValueWriter, i interface{}) error {
	...
	case *[]*bson.Element:
		slce = *t
	default:
		return CodecEncodeError{Codec: esc, Types: []interface{}{[]*bson.Element{}, (*[]*bson.Element)(nil)}, Received: i}
	}

	return defaultDocumentCodec.EncodeValue(ec, vw, (&bson.Document{}).Append(slce...))
}
