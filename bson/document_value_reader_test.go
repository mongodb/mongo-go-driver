...
func TestDocumentValueReader(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			[]interface{}{0, nil, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeBinary)},
		},
		{
			"ReadBinary/success",
			VC.BinaryWithSubtype([]byte{0x01, 0x02, 0x03}, 0xEA),
			reflect.ValueOf((*documentValueReader).ReadBinary),
			[]interface{}{0xEA, []byte{0x01, 0x02, 0x03}, nil},
		},
		{
		...
		},
		{
			...
			[]interface{}{0, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeDateTime)},
		},
		{
		...
		},
		{
			...
			[]interface{}{0, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeDouble)},
		},
		{
			"ReadDouble/success",
			VC.Double(1.2345),
		...
		},
		{
			...
			[]interface{}{0, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeInt32)},
		},
		{
			"ReadInt32/success",
			VC.Int32(12345),
		...
		},
		{
			...
			[]interface{}{0, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeInt64)},
		},
		{
			"ReadInt64/success",
			VC.Int64(1234567890),
			reflect.ValueOf((*documentValueReader).ReadInt64),
			[]interface{}{1234567890, nil},
		},
		{
		...
		},
		{
			...
			[]interface{}{0, 0, (&documentValueReader{stack: []dvrState{{}}}).typeError(TypeTimestamp)},
		},
		{
	...
	t.Run("Skip/invalid mode", func(t *testing.T) {
		dvr := &documentValueReader{stack: []dvrState{{mode: vrTopLevel}}}
		wanterr := (&documentValueReader{stack: []dvrState{{mode: vrTopLevel}}}).invalidTransitionErr(0)
		goterr := dvr.Skip()
