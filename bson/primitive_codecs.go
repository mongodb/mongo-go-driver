...
func (pc PrimitiveCodecs) DocumentEncodeValue(ec bsoncodec.EncodeContext, vw bsonrw.ValueWriter, i interface{}) error {
	doc, ok := i.(*Documentv2)
	if !ok {
		return bsoncodec.ValueEncoderError{Name: "DocumentEncodeValue", Types: []interface{}{(*Documentv2)(nil), (**Documentv2)(nil)}, Received: i}
	}
...
func (pc PrimitiveCodecs) ValueDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, i interface{}) error {
	pval, ok := i.(*Valuev2)
	if !ok {
		return bsoncodec.ValueDecoderError{Name: "ValueDecodeValue", Types: []interface{}{(*Valuev2)(nil)}, Received: i}
	}
...
func (pc PrimitiveCodecs) ElementSliceEncodeValue(ec bsoncodec.EncodeContext, vw bsonrw.ValueWriter, i interface{}) error {
	...
	default:
		return bsoncodec.ValueEncoderError{
			...
			Types:    []interface{}{[]Elementv2{}, (*[]Elementv2)(nil)},
			Received: i,
		}
	}

	return pc.DocumentEncodeValue(ec, vw, (&Documentv2{}).AppendElements(slce...))
}
...
func (pc PrimitiveCodecs) ElementSliceDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, i interface{}) error {
	...
	target, ok := i.(*[]Elementv2)
	if !ok || target == nil {
		return bsoncodec.ValueDecoderError{Name: "ElementSliceDecodeValue", Types: []interface{}{(*[]Elementv2)(nil)}, Received: i}
	}
...
func (pc PrimitiveCodecs) DocumentDecodeValue(dctx bsoncodec.DecodeContext, vr bsonrw.ValueReader, i interface{}) error {
	doc, ok := i.(**Documentv2)
	if !ok {
		return bsoncodec.ValueDecoderError{Name: "DocumentDecodeValue", Types: []interface{}{(**Documentv2)(nil)}, Received: i}
	}
...
func (pc PrimitiveCodecs) ArrayEncodeValue(ec bsoncodec.EncodeContext, vw bsonrw.ValueWriter, i interface{}) error {
	arr, ok := i.(*Arrayv2)
	if !ok {
		return bsoncodec.ValueEncoderError{Name: "ArrayEncodeValue", Types: []interface{}{(*Arrayv2)(nil)}, Received: i}
	}
...
func (pc PrimitiveCodecs) ArrayDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, i interface{}) error {
	parr, ok := i.(**Arrayv2)
	if !ok {
		return bsoncodec.ValueDecoderError{Name: "ArrayDecodeValue", Types: []interface{}{(**Arrayv2)(nil)}, Received: i}
	}
...
func (PrimitiveCodecs) EmptyInterfaceDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, i interface{}) error {
	...
	case bsontype.EmbeddedDocument:
		val = new(*Documentv2)
		rtype = tDocument
		fn = func() { *target = *val.(**Documentv2) }
	case bsontype.Array:
		val = new(*Arrayv2)
		rtype = tArray
		fn = func() { *target = *val.(**Arrayv2) }
...
func (pc PrimitiveCodecs) encodeDocument(ec bsoncodec.EncodeContext, dw bsonrw.DocumentWriter, doc *Documentv2) error {
...
func (pc PrimitiveCodecs) elementDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, key string, elem *Elementv2) error {
	var val Valuev2
	switch vr.Type() {
	case bsontype.Double:
	...
	case bsontype.EmbeddedDocument:
		...
		var embeddedDoc *Documentv2
		err = decoder.DecodeValue(dc, vr, &embeddedDoc)
		if err != nil {
			return err
		}
		val = Embed(embeddedDoc)
	case bsontype.Array:
	...
	*elem = Elementv2{Key: key, Value: val}
	return nil
}

func (pc PrimitiveCodecs) decodeDocument(dctx bsoncodec.DecodeContext, dr bsonrw.DocumentReader, pdoc **Documentv2) error {
	doc := NewDocumentv2()
	for {
		key, vr, err := dr.ReadElement()
		if err == bsonrw.ErrEOD {
...
// this method.
func (pc PrimitiveCodecs) encodeValue(ec bsoncodec.EncodeContext, vw bsonrw.ValueWriter, val Valuev2) error {
	var err error
	switch val.Type() {
	case bsontype.Double:
...
func (pc PrimitiveCodecs) valueDecodeValue(dc bsoncodec.DecodeContext, vr bsonrw.ValueReader, val *Valuev2) error {
	switch vr.Type() {
	case bsontype.Double:
		f64, err := vr.ReadDouble()
		if err != nil {
