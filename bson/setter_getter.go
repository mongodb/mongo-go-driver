...
// Setter interface: a value implementing the Setter interface will receive the BSON
// value via the SetBSON method during unmarshaling, and the object
// itself will not be changed as usual.
//
// If setting the value works, the method should return nil or alternatively
// ErrSetZero to set the respective field to its zero value (nil for
...
//
//	func (s *MyString) SetBSON(raw RawValue) error {
...
// Getter interface: a value implementing the Getter interface will have its GetBSON
