...
// NewDecoder returns a new decoder that uses DecodeContext dc to read from r.
...
// NewDecoderWithRegistry returns a new decoder that uses Registry reg to read from r.
