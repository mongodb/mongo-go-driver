...
// ReadKeyBytes will return the first key in src as bytes. The 0x00 byte will
...
// ReadHeaderBytes will return the type and key in src as rem and the remainder of the bytes
// in rem. If either the type or key cannot be red, ok will be false.
