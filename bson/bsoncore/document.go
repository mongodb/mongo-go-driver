...
// Elements returns this document as a slice of elements. The slice of elements will be all
// available valid elements. If the document is not valid, an error will also be returned.
...
// Values returns this document as a slice of values. The slice of values will be all valid values
// in the document. If the document is not completely valid, an error will also be returned.
