...
//
// If the key does not exist or there is any other problem parsing the
// document to this point, Value will be nil.
...
//
// If the key does not exist or there is any other problem parsing the
// document to this point, Element will be nil.
...
// provided key. Each key provided to this method represents a layer of depth.
//
// If the key does not exist or there is a problem parsing the
// document, Element will be nil, and the error value will be non-nil.
