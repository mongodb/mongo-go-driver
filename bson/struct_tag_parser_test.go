...
func TestStructTagParsers(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			&structTags{Name: "bar"},
			DefaultStructTagParser.parseStructTags,
		},
		{
			"default empty",
		...
		},
		{
			...
			&structTags{
				Name: "bar", Inline: true, OmitEmpty: true,
		...
		},
		{
			...
			&structTags{
				Name: "foo", Inline: true, OmitEmpty: true,
				LookupEncoderOnMinSize:  retrieverOnMinSize{},
				LookupEncoderOnTruncate: retrieverOnTruncate{},
			},
			DefaultStructTagParser.parseStructTags,
		...
		},
		{
			...
			reflect.StructField{Name: "foo", Tag: reflect.StructTag("bar")},
			&structTags{Name: "bar"},
			DefaultStructTagParser.parseJSONStructTags,
		},
		{
			"JSONFallback empty",
			reflect.StructField{Name: "foo", Tag: reflect.StructTag("")},
