...
func (v Valuev2) IsZero() bool { return v.t == bsontype.Type(0) || v.t == bsontype.Null }
...
func (v Valuev2) MarshalBSONValue() (bsontype.Type, []byte, error) {
	t := v.Type()
	var data []byte
	var err error
	switch v.Type() {
	...
	case TypeEmbeddedDocument:
		data, err = v.Document().MarshalBSON()
	case TypeArray:
		_, data, err = v.Array().MarshalBSONValue()
	case TypeBinary:
		subtype, data := v.Binary()
		data = bsoncore.AppendBinary(data, subtype, data)
	case TypeUndefined:
	case TypeObjectID:
...
func (v *Valuev2) UnmarshalBSONValue(t bsontype.Type, data []byte) error {
	if v == nil {
	...
	case TypeBinary:
		var subtype byte
		var data []byte
		subtype, data, rem, ok = bsoncore.ReadBinary(data)
		*v = Binary(subtype, data)
	case TypeUndefined:
		*v = Undefined()
	case TypeObjectID:
	...
	case TypeCodeWithScope:
		var raw []byte
		var code string
		var scope *Documentv2
		code, raw, rem, ok = bsoncore.ReadCodeWithScope(data)
		scope, err = ReadDocumentv2(raw)
...
func (v Valuev2) Type() bsontype.Type {
...
// panicking.
func (v Valuev2) BinaryOK() (byte, []byte, bool) {
	if v.t != bsontype.Binary {
...
// panicking.
func (v Valuev2) UndefinedOK() bool {
	if v.t != bsontype.Undefined {
		return false
	}
	return true
...
// other than regex.
func (v Valuev2) Regex() (pattern, options string) {
...
// instead of panicking.
func (v Valuev2) RegexOK() (pattern, options string, ok bool) {
	if v.t != bsontype.Regex {
		return "", "", false
	}
	regex := v.primitive.(primitive.Regex)
...
func (v Valuev2) DBPointer() (string, objectid.ObjectID) {
...
// instead of panicking.
func (v Valuev2) DBPointerOK() (string, objectid.ObjectID, bool) {
	if v.t != bsontype.DBPointer {
		return "", objectid.ObjectID{}, false
	}
	dbptr := v.primitive.(primitive.DBPointer)
...
func (v Valuev2) JavaScript() string {
...
// instead of panicking.
func (v Valuev2) JavaScriptOK() (string, bool) {
	if v.t != bsontype.JavaScript {
		return "", false
	}
	return v.string(), true
...
// instead of panicking.
func (v Valuev2) SymbolOK() (string, bool) {
	if v.t != bsontype.Symbol {
		return "", false
	}
	return v.string(), true
...
func (v Valuev2) Timestamp() (t, i uint32) {
...
// instead of panicking.
func (v Valuev2) TimestampOK() (t uint32, i uint32, ok bool) {
	if v.t != bsontype.Timestamp {
		return 0, 0, false
	}
	return uint32(v.bootstrap[4]) | uint32(v.bootstrap[5])<<8 |
...
func (v Valuev2) Equal(v2 Valuev2) bool {
	...
	case TypeCodeWithScope:
		code1, scope1 := v.primitive.(primitive.CodeWithScope).Code, v.primitive.(primitive.CodeWithScope).Scope.(*Documentv2)
		code2, scope2 := v2.primitive.(primitive.CodeWithScope).Code, v2.primitive.(primitive.CodeWithScope).Scope.(*Documentv2)
		return code1 == code2 && scope1.Equal(scope2)
	case TypeInt32:
