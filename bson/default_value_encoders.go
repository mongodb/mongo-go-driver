...
func registerDefaultEncoders(reg *Registry) {
	...
	reg.RegisterTypeEncoder(tByteSlice, defaultByteSliceCodec)
	reg.RegisterTypeEncoder(tTime, defaultTimeCodec)
	reg.RegisterTypeEncoder(tEmpty, defaultEmptyInterfaceCodec)
	reg.RegisterTypeEncoder(tCoreArray, defaultArrayCodec)
	...
	reg.RegisterKindEncoder(reflect.Uint, defaultUIntCodec)
	reg.RegisterKindEncoder(reflect.Uint8, defaultUIntCodec)
	reg.RegisterKindEncoder(reflect.Uint16, defaultUIntCodec)
	reg.RegisterKindEncoder(reflect.Uint32, defaultUIntCodec)
	reg.RegisterKindEncoder(reflect.Uint64, defaultUIntCodec)
	...
	reg.RegisterKindEncoder(reflect.Map, defaultMapCodec)
	reg.RegisterKindEncoder(reflect.Slice, defaultSliceCodec)
	reg.RegisterKindEncoder(reflect.String, defaultStringCodec)
	reg.RegisterKindEncoder(reflect.Struct, newDefaultStructCodec())
	reg.RegisterKindEncoder(reflect.Ptr, NewPointerCodec())
