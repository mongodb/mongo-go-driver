...
// Next fetches the next element of the Array, returning whether or not it could be fetched successfully. If true is
// returned, call Element to get the element. If false is returned, call Err to check if an error occurred.
...
// Value returns the current vlaue of the ArrayIterator. The pointer returned will _always_ be the same for a given
// ArrayIterator.
