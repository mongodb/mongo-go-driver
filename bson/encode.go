...
type Encoder interface {
	...
	// field but this behavior may be changed using the respective field tag. The tag may also
	// contain flags to tweak the marshalling behavior for the field. The tag formats accepted
	// are:
	//
	//     "[<key>][,<flag1>[,<flag2>]]"
	//
