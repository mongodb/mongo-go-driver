...
func (v *Value) Interface() interface{} {
	...
	case TypeRegex:
		p, o := v.Regex()
		return RegexPrimitive{Pattern: p, Options: o}
	case TypeDBPointer:
		db, pointer := v.DBPointer()
		return DBPointerPrimitive{DB: db, Pointer: pointer}
	case TypeJavaScript:
		return v.JavaScript()
	case TypeSymbol:
		return v.Symbol()
	case TypeCodeWithScope:
		...
		return CodeWithScopePrimitive{Code: JavaScriptCodePrimitive(code), Scope: scope}
	case TypeInt32:
		return v.Int32()
	case TypeTimestamp:
		t, i := v.Timestamp()
		return TimestampPrimitive{T: t, I: i}
	case TypeInt64:
		return v.Int64()
	case TypeDecimal128:
		return v.Decimal128()
