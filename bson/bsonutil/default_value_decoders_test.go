...
func TestDefaultValueDecoders(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			[]subtest{
				...
				},
				{
					...
					bool(true),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeBoolean, readval: bool(true)},
				...
				},
				{
					...
					mybool(true),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeBoolean, readval: bool(true), err: errors.New("ReadBoolean Error")},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(0)},
				...
				},
				{
					...
					0,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(0), err: errors.New("ReadInt32 error"), errAfter: bsonrwtest.ReadInt32},
					bsonrwtest.ReadInt32,
				...
				},
				{
					...
					0,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(0), err: errors.New("ReadInt64 error"), errAfter: bsonrwtest.ReadInt64},
				...
				},
				{
					...
					0,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(0), err: errors.New("ReadDouble error"), errAfter: bsonrwtest.ReadDouble},
					bsonrwtest.ReadDouble,
					errors.New("ReadDouble error"),
				},
				{
					"ReadDouble", int64(3), &DecodeContext{},
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(3.00)}, bsonrwtest.ReadDouble,
					nil,
				},
				{
					"ReadDouble (truncate)", int64(3), &DecodeContext{Truncate: true},
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(3.14)}, bsonrwtest.ReadDouble,
					nil,
				},
				{
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: math.MaxFloat64}, bsonrwtest.ReadDouble,
					fmt.Errorf("%g overflows int64", math.MaxFloat64),
				},
				{"int8/fast path", int8(127), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(127)}, bsonrwtest.ReadInt32, nil},
				{"int16/fast path", int16(32676), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(32676)}, bsonrwtest.ReadInt32, nil},
				{"int32/fast path", int32(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(1234)}, bsonrwtest.ReadInt32, nil},
				{"int64/fast path", int64(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1234)}, bsonrwtest.ReadInt64, nil},
				{"int/fast path", int(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1234)}, bsonrwtest.ReadInt64, nil},
				{
					"int8/fast path - nil", (*int8)(nil), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(0)}, bsonrwtest.ReadInt32,
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(129)}, bsonrwtest.ReadInt32,
					fmt.Errorf("%d overflows int8", 129),
				},
				{
					"int16/fast path - overflow", int16(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(32768)}, bsonrwtest.ReadInt32,
					fmt.Errorf("%d overflows int16", 32768),
				},
				{
					"int32/fast path - overflow", int32(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(2147483648)}, bsonrwtest.ReadInt64,
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(-32769)}, bsonrwtest.ReadInt32,
					fmt.Errorf("%d overflows int16", -32769),
				},
				{
					"int32/fast path - overflow (negative)", int32(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(-2147483649)}, bsonrwtest.ReadInt64,
					fmt.Errorf("%d overflows int32", -2147483649),
				},
				{
					"int8/reflection path", myint8(127), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(127)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
					"int16/reflection path", myint16(255), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(255)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
					"int32/reflection path", myint32(511), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(511)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
					"int64/reflection path", myint64(1023), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(1023)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
					"int/reflection path", myint(2047), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(2047)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
		...
		},
		{
			...
			[]subtest{
				...
				{"uint8/fast path", uint8(127), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(127)}, bsonrwtest.ReadInt32, nil},
				{"uint16/fast path", uint16(255), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(255)}, bsonrwtest.ReadInt32, nil},
				{"uint32/fast path", uint32(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(1234)}, bsonrwtest.ReadInt32, nil},
				{"uint64/fast path", uint64(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1234)}, bsonrwtest.ReadInt64, nil},
				{"uint/fast path", uint(1234), nil, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1234)}, bsonrwtest.ReadInt64, nil},
				{
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(1 << 8)}, bsonrwtest.ReadInt32,
					fmt.Errorf("%d overflows uint8", 1<<8),
				},
				{
					"uint16/fast path - overflow", uint16(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(1 << 16)}, bsonrwtest.ReadInt32,
					fmt.Errorf("%d overflows uint16", 1<<16),
				},
				{
					"uint32/fast path - overflow", uint32(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1 << 32)}, bsonrwtest.ReadInt64,
					fmt.Errorf("%d overflows uint32", 1<<32),
				},
				{
					"uint8/fast path - overflow (negative)", uint8(0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(-1)}, bsonrwtest.ReadInt32,
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(-1)}, bsonrwtest.ReadInt64,
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(0)},
					bsonrwtest.ReadDouble,
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(32)}, bsonrwtest.ReadInt32,
					nil,
				},
				{
					"float64/int64", float32(64.0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(64)}, bsonrwtest.ReadInt64,
					nil,
				},
				{
					"float32/fast path (equal)", float32(3.0), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(3.0)}, bsonrwtest.ReadDouble,
					nil,
				},
				{
					"float64/fast path", float64(3.14159), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(3.14159)}, bsonrwtest.ReadDouble,
					nil,
				},
				{
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(0)}, bsonrwtest.ReadDouble,
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("")},
				...
				},
				{
					...
					string(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string(""), err: errors.New("ReadString error"), errAfter: bsonrwtest.ReadString},
					bsonrwtest.ReadString,
				...
				},
				{
					...
					string(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeJavaScript, readval: string(""), err: errors.New("ReadJS error"), errAfter: bsonrwtest.ReadJavascript},
				...
				},
				{
					...
					string(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeSymbol, readval: string(""), err: errors.New("ReadSymbol error"), errAfter: bsonrwtest.ReadSymbol},
				...
				},
				{
					...
					string("foobar"),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("foobar")},
					bsonrwtest.ReadString,
					nil,
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeJavaScript, readval: string("var hello = 'world';")},
					bsonrwtest.ReadJavascript,
					nil,
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeSymbol, readval: bson.Symbol("foobarbaz")},
					bsonrwtest.ReadSymbol,
					nil,
				},
				{
					"string/fast path - nil", (*string)(nil), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("")}, bsonrwtest.ReadString,
				...
				},
				{
					...
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeJavaScript, readval: string("")}, bsonrwtest.ReadJavascript,
					errors.New("StringDecodeValue can only be used to decode non-nil *JavaScriptCode"),
				},
				{
					"Symbol/fast path - nil", (*bson.Symbol)(nil), nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeSymbol, readval: bson.Symbol("")}, bsonrwtest.ReadSymbol,
				...
				},
				{
					...
					mystring("foobarbaz"),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("foobarbaz")},
					bsonrwtest.ReadString,
					nil,
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("foobarbazqux"), err: errors.New("ReadString Error"), errAfter: bsonrwtest.ReadString},
					bsonrwtest.ReadString, errors.New("ReadString Error"),
				},
				{
					"can set false",
					cansetreflectiontest,
		...
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					int64(0),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDateTime, readval: int64(1234567890)},
				...
				},
				{
					...
					time.Time{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDateTime, readval: int64(0), err: errors.New("ReadDateTime error"), errAfter: bsonrwtest.ReadDateTime},
					bsonrwtest.ReadDateTime,
				...
				},
				{
					...
					now,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDateTime, readval: int64(now.UnixNano() / int64(time.Millisecond))},
					bsonrwtest.ReadDateTime,
					nil,
				},
				{
		...
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					&DecodeContext{Registry: NewRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, err: errors.New("dv error"), errAfter: bsonrwtest.ReadString},
					bsonrwtest.ReadString,
					errors.New("dv error"),
				},
			},
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					[]interface{}{},
					nil,
					&bsonrwtest.ValueReaderWriter{err: errors.New("ra error"), errAfter: bsonrwtest.ReadArray, BSONType: bson.TypeArray},
				...
				},
				{
					...
					[]string{},
					&DecodeContext{Registry: NewEmptyRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeArray},
					bsonrwtest.ReadArray,
					ErrNoDecoder{Type: reflect.TypeOf(string(""))},
				},
				{
					...
					[]string{},
					&DecodeContext{Registry: NewRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{err: errors.New("rv error"), errAfter: bsonrwtest.ReadValue, BSONType: bson.TypeArray},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeBinary, readval: bson.Binary{}},
				...
				},
				{
					...
					bson.Binary{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeBinary, err: errors.New("rb error"), errAfter: bsonrwtest.ReadBinary},
					bsonrwtest.ReadBinary,
					errors.New("rb error"),
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeBinary, readval: bson.Binary{Data: []byte{0x01, 0x02, 0x03}, Subtype: 0xFF}},
					bsonrwtest.ReadBinary,
					nil,
				},
				{
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeUndefined},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.Undefinedv2{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeUndefined, err: errors.New("ru error"), errAfter: bsonrwtest.ReadUndefined},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeObjectID},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					objectid.ObjectID{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeObjectID, err: errors.New("roid error"), errAfter: bsonrwtest.ReadObjectID},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDateTime},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.DateTime(0),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDateTime, err: errors.New("rdt error"), errAfter: bsonrwtest.ReadDateTime},
					bsonrwtest.ReadDateTime,
		...
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					bson.Nullv2{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeNull, err: errors.New("rn error"), errAfter: bsonrwtest.ReadNull},
					bsonrwtest.ReadNull,
					errors.New("rn error"),
				},
				{
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeRegex},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.Regex{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeRegex, err: errors.New("rr error"), errAfter: bsonrwtest.ReadRegex},
				...
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeRegex, readval: bson.Regex{Pattern: "foo", Options: "bar"}},
					bsonrwtest.ReadRegex,
					nil,
				},
			},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDBPointer},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.DBPointer{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDBPointer, err: errors.New("rdbp error"), errAfter: bsonrwtest.ReadDBPointer},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeCodeWithScope},
					bsonrwtest.Nothing,
					ValueDecoderError{
				...
				},
				{
					...
					bson.CodeWithScope{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeCodeWithScope, err: errors.New("rcws error"), errAfter: bsonrwtest.ReadCodeWithScope},
				...
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeCodeWithScope, err: errors.New("dd error"), errAfter: bsonrwtest.ReadElement},
					bsonrwtest.ReadElement,
					errors.New("dd error"),
				},
			},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeTimestamp},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.Timestamp{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeTimestamp, err: errors.New("rt error"), errAfter: bsonrwtest.ReadTimestamp},
				...
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeTimestamp, readval: bson.Timestamp{T: 12345, I: 67890}},
					bsonrwtest.ReadTimestamp,
					nil,
				},
			},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDecimal128},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					decimal.Decimal128{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDecimal128, err: errors.New("rd128 error"), errAfter: bsonrwtest.ReadDecimal128},
				...
				},
				{
					...
					d128,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDecimal128, readval: d128},
					bsonrwtest.ReadDecimal128,
					nil,
				},
			},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeMinKey},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.MinKeyv2{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeMinKey, err: errors.New("rn error"), errAfter: bsonrwtest.ReadMinKey},
			...
			[]subtest{
				{
					...
					wrong,
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeMaxKey},
					bsonrwtest.Nothing,
				...
				},
				{
					...
					bson.MaxKeyv2{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeMaxKey, err: errors.New("rn error"), errAfter: bsonrwtest.ReadMaxKey},
		...
		},
		{
			...
			[]subtest{
				...
				{"invalid value", (**bson.Value)(nil), nil, nil, bsonrwtest.Nothing, errors.New("ValueDecodeValue can only be used to decode non-nil **Value")},
				{
					"success",
					bson.VC.Double(3.14159),
					&DecodeContext{Registry: NewRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, readval: float64(3.14159)},
					bsonrwtest.ReadDouble,
					nil,
				},
			},
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					json.Number(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeDouble, err: errors.New("rd error"), errAfter: bsonrwtest.ReadDouble},
					bsonrwtest.ReadDouble,
					errors.New("rd error"),
				},
				{
					...
					json.Number(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, err: errors.New("ri32 error"), errAfter: bsonrwtest.ReadInt32},
					bsonrwtest.ReadInt32,
				...
				},
				{
					...
					json.Number(""),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, err: errors.New("ri64 error"), errAfter: bsonrwtest.ReadInt64},
					bsonrwtest.ReadInt64,
				...
				},
				{
					...
					json.Number("12345"),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt32, readval: int32(12345)},
					bsonrwtest.ReadInt32,
					nil,
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeInt64, readval: int64(1234567890)},
					bsonrwtest.ReadInt64,
					nil,
				},
			},
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					int64(0),
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("http://example.com")},
					bsonrwtest.ReadString,
				...
				},
				{
					...
					url.URL{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, err: errors.New("rs error"), errAfter: bsonrwtest.ReadString},
					bsonrwtest.ReadString,
					errors.New("rs error"),
				},
				{
					...
					url.URL{},
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("not-valid-%%%%://")},
					bsonrwtest.ReadString,
		...
		},
		{
			...
			[]subtest{
				...
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, err: errors.New("copy error"), errAfter: bsonrwtest.ReadString},
					bsonrwtest.ReadString,
					errors.New("copy error"),
				},
				{
					...
					nil,
					&bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("hello, world")},
					bsonrwtest.ReadString,
					nil,
				},
				{
	...
	t.Run("ValueUnmarshalerDecodeValue/UnmarshalBSONValue error", func(t *testing.T) {
		var dc DecodeContext
		llvrw := &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeString, readval: string("hello, world!")}
		llvrw.t = t
	...
	t.Run("DocumentDecodeValue", func(t *testing.T) {
		t.Run("CodecDecodeError", func(t *testing.T) {
			...
			got := dvd.DocumentDecodeValue(DecodeContext{}, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeEmbeddedDocument}, val)
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
		...
		t.Run("decodeDocument errors", func(t *testing.T) {
			...
			testCases := []struct {
				...
				{"ReadDouble", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadDouble, BSONType: bson.TypeDouble}, err},
				{"ReadString", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadString, BSONType: bson.TypeString}, err},
				{
					"ReadDocument (Lookup)", DecodeContext{Registry: NewEmptyRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{t: t, BSONType: bson.TypeEmbeddedDocument},
					ErrNoDecoder{Type: tDocument},
				},
				{
					"ReadArray (Lookup)", DecodeContext{Registry: NewEmptyRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{t: t, BSONType: bson.TypeArray},
					ErrNoDecoder{Type: tArray},
				},
				{"ReadBinary", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadBinary, BSONType: bson.TypeBinary}, err},
				{"ReadUndefined", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadUndefined, BSONType: bson.TypeUndefined}, err},
				{"ReadObjectID", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadObjectID, BSONType: bson.TypeObjectID}, err},
				{"ReadBoolean", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadBoolean, BSONType: bson.TypeBoolean}, err},
				{"ReadDateTime", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadDateTime, BSONType: bson.TypeDateTime}, err},
				{"ReadNull", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadNull, BSONType: bson.TypeNull}, err},
				{"ReadRegex", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadRegex, BSONType: bson.TypeRegex}, err},
				{"ReadDBPointer", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadDBPointer, BSONType: bson.TypeDBPointer}, err},
				{"ReadJavascript", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadJavascript, BSONType: bson.TypeJavaScript}, err},
				{"ReadSymbol", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadSymbol, BSONType: bson.TypeSymbol}, err},
				{
					"ReadCodeWithScope (Lookup)", DecodeContext{Registry: NewEmptyRegistryBuilder().Build()},
					&bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadCodeWithScope, BSONType: bson.TypeCodeWithScope},
					err,
				},
				{"ReadInt32", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadInt32, BSONType: bson.TypeInt32}, err},
				{"ReadInt64", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadInt64, BSONType: bson.TypeInt64}, err},
				{"ReadTimestamp", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadTimestamp, BSONType: bson.TypeTimestamp}, err},
				{"ReadDecimal128", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadDecimal128, BSONType: bson.TypeDecimal128}, err},
				{"ReadMinKey", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadMinKey, BSONType: bson.TypeMinKey}, err},
				{"ReadMaxKey", dc, &bsonrwtest.ValueReaderWriter{t: t, err: err, errAfter: bsonrwtest.ReadMaxKey, BSONType: bson.TypeMaxKey}, err},
				{"Invalid Type", dc, &bsonrwtest.ValueReaderWriter{t: t, BSONType: bson.Type(0)}, fmt.Errorf("Cannot read unknown BSON type %s", bson.Type(0))},
			}
	...
	t.Run("ArrayDecodeValue", func(t *testing.T) {
		t.Run("CodecDecodeError", func(t *testing.T) {
			...
			got := dvd.ArrayDecodeValue(DecodeContext{}, &bsonrwtest.ValueReaderWriter{BSONType: bson.TypeArray}, val)
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
	...
	t.Run("EmptyInterfaceDecodeValue", func(t *testing.T) {
		...
		t.Run("unknown BSON type", func(t *testing.T) {
			llvr := &bsonrwtest.ValueReaderWriter{BSONType: bson.Type(0)}
