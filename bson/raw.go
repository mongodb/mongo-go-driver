...
// valid elements. If the document is not valid, an error will also be returned.
...
// Values returns this document as a slice of values. The slice of values will all be valid
// elements. If the document is not valid, an error will also be returned.
