...
// representation.
//
// TODO(skriptble): Either rename this to NewBSONValueReader or rename NewBSONValueWriter to
// NewValueWriter. It's also weird that this function takes a []byte and not an io.Reader. We have
// time to rethink this package's public API, but we should likely have io.Reader/Writer and []byte
