...
func (dvw *documentValueWriter) WriteDBPointer(ns string, oid objectid.ObjectID) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.DBPointer(dvw.stack[dvw.frame].key, ns, oid))
	return nil
}
...
func (dvw *documentValueWriter) WriteDateTime(dt int64) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.DateTime(dvw.stack[dvw.frame].key, dt))
	return nil
}
...
func (dvw *documentValueWriter) WriteDecimal128(d128 decimal.Decimal128) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Decimal128(dvw.stack[dvw.frame].key, d128))
	return nil
}
...
func (dvw *documentValueWriter) WriteDouble(f64 float64) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Double(dvw.stack[dvw.frame].key, f64))
	return nil
}
...
func (dvw *documentValueWriter) WriteJavascript(code string) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.JavaScript(dvw.stack[dvw.frame].key, code))
	return nil
}
...
func (dvw *documentValueWriter) WriteMaxKey() error {
	...
	dvw.stack[dvw.frame].d.Append(EC.MaxKey(dvw.stack[dvw.frame].key))
	return nil
}
...
func (dvw *documentValueWriter) WriteMinKey() error {
	...
	dvw.stack[dvw.frame].d.Append(EC.MinKey(dvw.stack[dvw.frame].key))
	return nil
}
...
func (dvw *documentValueWriter) WriteNull() error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Null(dvw.stack[dvw.frame].key))
	return nil
}
...
func (dvw *documentValueWriter) WriteObjectID(oid objectid.ObjectID) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.ObjectID(dvw.stack[dvw.frame].key, oid))
	return nil
}
...
func (dvw *documentValueWriter) WriteRegex(pattern string, options string) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Regex(dvw.stack[dvw.frame].key, pattern, options))
	return nil
}
...
func (dvw *documentValueWriter) WriteString(str string) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.String(dvw.stack[dvw.frame].key, str))
	return nil
}
...
func (dvw *documentValueWriter) WriteSymbol(symbol string) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Symbol(dvw.stack[dvw.frame].key, symbol))
	return nil
}
...
func (dvw *documentValueWriter) WriteTimestamp(t uint32, i uint32) error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Timestamp(dvw.stack[dvw.frame].key, t, i))
	return nil
}
...
func (dvw *documentValueWriter) WriteUndefined() error {
	...
	dvw.stack[dvw.frame].d.Append(EC.Undefined(dvw.stack[dvw.frame].key))
	return nil
}
