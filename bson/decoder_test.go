...
func TestDecoderv2(t *testing.T) {
	t.Run("Decode", func(t *testing.T) {
		...
		t.Run("lookup error", func(t *testing.T) {
			type certainlydoesntexistelsewhereihope uint64
			cdeih := certainlydoesntexistelsewhereihope(987654321)
...
func (tdc *testDecoderCodec) EncodeValue(*Registry, ValueWriter, interface{}) error {
	tdc.EncodeValueCalled = true
	return nil
}

func (tdc *testDecoderCodec) DecodeValue(*Registry, ValueReader, interface{}) error {
