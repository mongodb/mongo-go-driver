	...
	*pdatetime = primitive.DateTime(1234567890)
			...
			[]subtest{
				{
					...
					nil,
					bsonrwtest.Nothing,
					bsoncodec.ValueEncoderError{Name: "DEncodeValue", Types: []reflect.Type{tD}, Received: reflect.ValueOf(wrong)},
				},
	...
	t.Run("DocumentEncodeValue", func(t *testing.T) {
		...
		t.Run("WriteDocument Error", func(t *testing.T) {
			...
			got := (PrimitiveCodecs{}).x.DocumentEncodeValue(bsoncodec.EncodeContext{}, llvrw, reflect.MakeSlice(tDocument, 0, 0))
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
		t.Run("encodeDocument errors", func(t *testing.T) {
			...
			for _, tc := range testCases {
				t.Run(tc.name, func(t *testing.T) {
					err := (PrimitiveCodecs{}).x.DocumentEncodeValue(tc.ec, tc.llvrw, reflect.ValueOf(tc.doc))
		...
		t.Run("success", func(t *testing.T) {
			...
			err = (PrimitiveCodecs{}).x.DocumentEncodeValue(ec, vw, reflect.ValueOf(want))
			noerr(t, err)
	...
	t.Run("ArrayEncodeValue", func(t *testing.T) {
		...
		t.Run("WriteArray Error", func(t *testing.T) {
			...
			got := (PrimitiveCodecs{}).x.ArrayEncodeValue(bsoncodec.EncodeContext{}, llvrw, reflect.MakeSlice(tArray, 0, 0))
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
		t.Run("encode array errors", func(t *testing.T) {
			...
			for _, tc := range testCases {
				t.Run(tc.name, func(t *testing.T) {
					err := (PrimitiveCodecs{}).x.ArrayEncodeValue(tc.ec, tc.llvrw, reflect.ValueOf(tc.arr))
					if !compareErrors(err, tc.err) {
						t.Errorf("Errors do not match. got %v; want %v", err, tc.err)
					}
				})
		...
		t.Run("success", func(t *testing.T) {
			...
			err = (PrimitiveCodecs{}).x.ArrayEncodeValue(ec, vr, reflect.ValueOf(want))
			noerr(t, err)
...
func TestDefaultValueDecoders(t *testing.T) {
	...
	*psymbol = primitive.Symbol("foobarbaz")
			...
			[]subtest{
				{
					...
					nil,
					bsonrwtest.Nothing,
					bsoncodec.ValueDecoderError{Name: "DDecodeValue", Types: []reflect.Type{tD}, Received: reflect.ValueOf(wrong)},
				},
				{
					"type not valid",
					D{},
	...
	t.Run("CodeWithScopeCodec/DecodeValue/success", func(t *testing.T) {
		...
		err = pc.CodeWithScopeDecodeValue(dc, vr, val)
		noerr(t, err)
	...
	t.Run("DocumentDecodeValue", func(t *testing.T) {
		...
		t.Run("ReadDocument Error", func(t *testing.T) {
			...
			got := pc.x.DocumentDecodeValue(bsoncodec.DecodeContext{}, llvrw, reflect.New(reflect.TypeOf(bsonx.Doc{})).Elem())
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
	...
	t.Run("ArrayDecodeValue", func(t *testing.T) {
		...
		t.Run("ReadArray Error", func(t *testing.T) {
			...
			got := pc.x.ArrayDecodeValue(bsoncodec.DecodeContext{}, llvrw, reflect.New(tArray).Elem())
			if !compareErrors(got, want) {
				t.Errorf("Errors do not match. got %v; want %v", got, want)
			}
		})
		t.Run("decode array errors", func(t *testing.T) {
			...
			for _, tc := range testCases {
				t.Run(tc.name, func(t *testing.T) {
					err := pc.x.ArrayDecodeValue(tc.dc, tc.llvrw, reflect.New(tArray).Elem())
					if !compareErrors(err, tc.err) {
						t.Errorf("Errors do not match. got %v; want %v", err, tc.err)
					}
				})
		...
		t.Run("success", func(t *testing.T) {
			...
			err = pc.x.ArrayDecodeValue(dc, vr, val)
			noerr(t, err)
