	...
	*pdatetime = primitive.DateTime(1234567890)
			...
			[]subtest{
				{
					...
					nil,
					bsonrwtest.Nothing,
					bsoncodec.ValueEncoderError{Name: "ValueEncodeValue", Types: []interface{}{Val{}}, Received: wrong},
				},
	...
	t.Run("ArrayEncodeValue", func(t *testing.T) {
		t.Run("CodecEncodeError", func(t *testing.T) {
			val := bool(true)
			want := bsoncodec.ValueEncoderError{Name: "ArrayEncodeValue", Types: []interface{}{(Arr)(nil)}, Received: val}
		...
		testCases := []struct {
			...
			},
			{
				...
				struct {
					...
					N:  [][]string{{"foo", "bar"}},
					O:  []Elem{{"N", Null()}},
					P:  []Doc{Doc{{"countdown", Int64(9876543210)}}},
