...
func NewRegistryOpt[T any](fn func(T)) *RegistryOpt {
	var zero [0]T
	return &RegistryOpt{
...
var NilByteSliceAsEmpty = NewRegistryOpt(func(c *byteSliceCodec) {
...
var BinaryAsSlice = NewRegistryOpt(func(c *emptyInterfaceCodec) {
...
var DefaultDocumentM = NewRegistryOpt(func(c *emptyInterfaceCodec) {
...
// behavior is restricted to data typed as "interface{}" or "map[string]interface{}".
var DefaultDocumentD = NewRegistryOpt(func(c *emptyInterfaceCodec) {
...
// null.
var NilMapAsEmpty = NewRegistryOpt(func(c *mapCodec) {
	c.encodeNilAsEmpty = true
})
...
var StringifyMapKeysWithFmt = NewRegistryOpt(func(c *mapCodec) {
...
var ZeroMaps = NewRegistryOpt(func(c *mapCodec) {
...
var AllowTruncatingDoubles = NewRegistryOpt(func(c *numCodec) {
	c.truncate = true
})
...
var ErrorOnInlineDuplicates = NewRegistryOpt(func(c *structCodec) {
...
var OmitZeroStruct = NewRegistryOpt(func(c *structCodec) {
...
var UseJSONStructTags = NewRegistryOpt(func(c *structCodec) {
