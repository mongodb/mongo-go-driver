...
var tBinary = reflect.TypeOf(BinaryPrimitive{})
var tBool = reflect.TypeOf(false)
var tCodeWithScope = reflect.TypeOf(CodeWithScopePrimitive{})
var tDBPointer = reflect.TypeOf(DBPointerPrimitive{})
...
var tDateTime = reflect.TypeOf(DateTimePrimitive(0))
var tUndefined = reflect.TypeOf(UndefinedPrimitive{})
var tNull = reflect.TypeOf(NullPrimitive{})
...
var tJavaScriptCode = reflect.TypeOf(JavaScriptCodePrimitive(""))
var tOID = reflect.TypeOf(objectid.ObjectID{})
var tRaw = reflect.TypeOf(Raw(nil))
var tRegex = reflect.TypeOf(RegexPrimitive{})
var tString = reflect.TypeOf("")
var tSymbol = reflect.TypeOf(SymbolPrimitive(""))
var tTime = reflect.TypeOf(time.Time{})
var tTimestamp = reflect.TypeOf(TimestampPrimitive{})
...
var tMinKey = reflect.TypeOf(MinKeyPrimitive{})
var tMaxKey = reflect.TypeOf(MaxKeyPrimitive{})
