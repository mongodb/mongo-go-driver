...
func FuzzDecode(f *testing.F) {
	seedCorpus := []struct{ buf []byte }{
		...
		// { "struct": { "emptyStruct": {} } }
		{[]byte("\x24\x00\x00\x00\x03\x73\x74\x72\x75\x63\x74\x00\x17\x00\x00\x00\x03\x65\x6d\x70\x74\x79\x53\x74\x72\x75\x63\x74\x00\x05\x00\x00\x00\x00\x00\x00")},

		// Document with an embedded array document.
		// { "slice": [ 1, 2.0, "3", 0x3a, 0x05, [ 6, 7.0, "8", 0x39, 0x0a ] ] }
		{[]byte("")},
	}
