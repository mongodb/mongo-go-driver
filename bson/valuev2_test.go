...
func TestValue(t *testing.T) {
	...
	js := "var hello ='world';"
	symbol := "foobarbaz"
	cws := primitive.CodeWithScope{Code: primitive.JavaScript(js), Scope: NewDocumentv2()}
	code, scope := js, NewDocumentv2()
	...
	testCases := []struct {
		...
		{"Interface/Document", Embed(NewDocumentv2()).Interface, []interface{}{NewDocumentv2()}, nil},
		{"Interface/Array", Embed(NewArrayv2()).Interface, []interface{}{NewArrayv2()}, nil},
		...
		{"Interface/CodeWithScope", CodeWithScope(string(cws.Code), cws.Scope.(*Documentv2)).Interface, []interface{}{cws}, nil},
		...
		{"Interface/Empty", Valuev2{}.Interface, []interface{}{primitive.Null{}}, nil},
		...
		{"String/15bytes", String(bytestr15).StringValue, []interface{}{string(bytestr15)}, nil},
		...
		{"Document/success", Embed(NewDocumentv2()).Document, []interface{}{NewDocumentv2()}, nil},
		{"DocumentOK/error", Double(0).DocumentOK, []interface{}{(*Documentv2)(nil), false}, nil},
		{"DocumentOK/success", Embed(NewDocumentv2()).DocumentOK, []interface{}{NewDocumentv2(), true}, nil},
		{"Array/panic", Double(0).Array, nil, ElementTypeError{"bson.Value.Array", bsontype.Double}},
		{"Array/success", Embed(NewArrayv2()).Array, []interface{}{NewArrayv2()}, nil},
		{"ArrayOK/error", Double(0).ArrayOK, []interface{}{(*Arrayv2)(nil), false}, nil},
		{"ArrayOK/success", Embed(NewArrayv2()).ArrayOK, []interface{}{NewArrayv2(), true}, nil},
		{"Embed/NilDocument", Embed((*Document)(nil)).Interface, []interface{}{primitive.Null{}}, nil},
		{"Embed/NilArray", Embed((*Array)(nil)).Interface, []interface{}{primitive.Null{}}, nil},
		{"Embed/Nil", Embed(nil).Interface, []interface{}{primitive.Null{}}, nil},
		...
		{"CodeWithScopeOK/error", Double(0).CodeWithScopeOK, []interface{}{"", (*Documentv2)(nil), false}, nil},
	...
	t.Run("Equal", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{"Document/Equal", Embed(NewDocumentv2()), Embed(NewDocumentv2()), true},
			{"Document/Not Equal", Embed(NewDocumentv2()), Embed(NewDocumentv2().Append("", Null())), false},
			{"Array/Equal", Embed(NewArrayv2()), Embed(NewArrayv2()), true},
			{"Array/Not Equal", Embed(NewArrayv2()), Embed(NewArrayv2(Null())), false},
			...
			{"CodeWithScope/Equal (equal scope)", CodeWithScope(code, scope), CodeWithScope(code, NewDocumentv2()), true},
