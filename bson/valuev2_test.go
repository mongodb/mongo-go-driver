...
func TestValue(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Interface/Document", Embed(NewDocumentv2()).Interface, NewDocumentv2(), nil},
		{"Interface/Array", Embed(NewArrayv2()).Interface, NewArrayv2(), nil},
		...
		{"Interface/Empty", Valuev2{}.Interface, NullPrimitive{}, nil},
		...
		{"Document/success", Embed(NewDocumentv2()).Document, NewDocumentv2(), nil},
		{"DocumentOK/error", Double(0).DocumentOK, (*Documentv2)(nil), false},
		{"DocumentOK/success", Embed(NewDocumentv2()).DocumentOK, NewDocumentv2(), true},
		{"Array/panic", Double(0).Array, nil, ElementTypeError{"bson.Value.Array", bsontype.Double}},
		{"Array/success", Embed(NewArrayv2()).Array, NewArrayv2(), nil},
		{"ArrayOK/error", Double(0).ArrayOK, (*Arrayv2)(nil), false},
		{"ArrayOK/success", Embed(NewArrayv2()).ArrayOK, NewArrayv2(), true},
	...
	t.Run("Equal", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{"Document/Not Equal", Embed(NewDocumentv2()), Embed(NewDocumentv2().Append("", Null(NullPrimitive{}))), false},
			{"Array/Equal", Embed(NewArrayv2()), Embed(NewArrayv2()), true},
			{"Array/Not Equal", Embed(NewArrayv2()), Embed(NewArrayv2(Null(NullPrimitive{}))), false},
