...
function compile_check {
  ...
  GOWORK=off GOOS=linux GOARCH=386 ${GC} -buildvcs=false build ./...
  GOWORK=off GOOS=linux GOARCH=arm ${GC} -buildvcs=false build ./...
  GOWORK=off GOOS=linux GOARCH=arm64 ${GC} -buildvcs=false build ./...
  GOWORK=off GOOS=linux GOARCH=amd64 ${GC} -buildvcs=false build ./...
  GOWORK=off GOOS=linux GOARCH=ppc64le ${GC} -buildvcs=false build ./...
  GOWORK=off GOOS=linux GOARCH=s390x ${GC} -buildvcs=false build ./...
