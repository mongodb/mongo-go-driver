...
import (
	...
	"github.com/mongodb/mongo-go-driver/options-design/mongo/mongoopts"
...
func (fb *FindBundle) Collation(collation *mongoopts.Collation) *FindBundle { return nil }
func (fb *FindBundle) Comment(s string) *FindBundle                         { return nil }
func (fb *FindBundle) CursorType(ct mongoopts.CursorType) *FindBundle       { return nil }
...
func (ob *OneBundle) Collation(collation *mongoopts.Collation) *OneBundle { return nil }
func (ob *OneBundle) Comment(s string) *OneBundle                         { return nil }
func (ob *OneBundle) CursorType(ct mongoopts.CursorType) *OneBundle       { return nil }
...
func (dob *DeleteOneBundle) Collation(collation *mongoopts.Collation) *DeleteOneBundle   { return nil }
...
func (rob *ReplaceOneBundle) Collation(collation *mongoopts.Collation) *ReplaceOneBundle { return nil }
...
func (rob *ReplaceOneBundle) ReturnDocument(rd mongoopts.ReturnDocument) *ReplaceOneBundle {
	return nil
}
...
func (uob *UpdateOneBundle) Collation(collation *mongoopts.Collation) *ReplaceOneBundle   { return nil }
...
func (uob *UpdateOneBundle) ReturnDocument(rd mongoopts.ReturnDocument) *ReplaceOneBundle { return nil }
...
func Collation(collation *mongoopts.Collation) OptCollation        { return OptCollation{} }    // Find, One, DeleteOne, ReplaceOne, UpdateOne
func CursorType(ct mongoopts.CursorType) OptCursorType             { return 0 }                 // Find, One
...
func ReturnDocument(rd mongoopts.ReturnDocument) OptReturnDocument { return 0 }                 // ReplaceOne, UpdateOne
