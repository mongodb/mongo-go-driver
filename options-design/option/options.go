...
type DeleteOneModelOptioner interface {
	Optioner
}

type DeleteManyModelOptioner interface {
	Optioner
}

type ReplaceOneModelOptioner interface {
	Optioner
}

type UpdateOneModelOptioner interface {
	Optioner
}

type UpdateManyModelOptioner interface {
	Optioner
}
...
func (opt OptAllowDiskUse) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptAllowPartialResults) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptArrayFilters) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptBatchSize) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptBypassDocumentValidation) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptCollation) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptComment) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptCursorType) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptFullDocument) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptHint) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptLimit) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptMax) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptMaxAwaitTime) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptMaxScan) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptMaxTime) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptMin) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptNoCursorTimeout) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptOplogReplay) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptOrdered) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptProjection) Option(d *bson.Document) error { return nil }

// IsFind is for internal use.
func (opt OptProjection) IsFind() OptProjection { return opt }
...
type OptReadConcern struct{ ReadConcern *readconcern.ReadConcern }

// Option implements the Optioner interface.
func (opt OptReadConcern) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptResumeAfter) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptReturnDocument) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptReturnKey) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptShowRecordID) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptSkip) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptSnapshot) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptSort) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptUpsert) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptWriteConcern) Option(d *bson.Document) error { return nil }
...
// Option implements the Optioner interface.
func (opt OptNameOnly) Option(d *bson.Document) error { return nil }
